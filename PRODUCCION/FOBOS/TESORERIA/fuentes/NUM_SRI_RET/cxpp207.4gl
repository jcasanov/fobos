...
CREATE UNIQUE INDEX tmp_pk2
	ON tmp_retenciones(tipo_doc, num_doc, tipo_ret, porc)
...
CREATE UNIQUE INDEX tmp_pk3
	ON tmp_tipo_porc(tipodoc, numdoc, tiporet, porcen)
LET vm_scr_lin = 0
...
--#DISPLAY 'Tipo'        TO tit_col7
--#DISPLAY 'Valor Base'  TO tit_col8
--#DISPLAY '%'           TO tit_col9
--#DISPLAY 'Subtotal'    TO tit_col10
