...
begin work;
	...
	unload to "eli_item_pow02_11.unl"
		select * from acero_gc@idsgye01:rept011
			where r11_compania in (1, 2)
			  and exists
				(select 1 from t5
					where t5.item = r11_item);

	delete from acero_gc@idsgye01:rept011
		where r11_compania in (1, 2)
		  and exists
			(select 1 from t5
				where t5.item = r11_item);

	delete from acero_gc@idsgye01:rept010
		where r10_compania in (1, 2)
		  and r10_marca     = 'POWERS'
		  and not exists
			(select 1 from t4
	...
	delete from acero_qm@idsuio01:rept011
		where r11_compania in (1, 2)
		  and exists
			(select 1 from t5
				where t5.item = r11_item);

	delete from acero_qm@idsuio01:rept010
		where r10_compania in (1, 2)
		  and r10_marca     = 'POWERS'
		  and not exists
			(select 1 from t4
	...
	unload to "eli_item_pow04_11.unl"
		select * from acero_qs@idsuio02:rept011
			where r11_compania in (1, 2)
			  and exists
				(select 1 from t5
					where t5.item = r11_item);

	delete from acero_qs@idsuio02:rept011
		where r11_compania in (1, 2)
		  and exists
			(select 1 from t5
				where t5.item = r11_item);

	delete from acero_qs@idsuio02:rept010
		where r10_compania in (1, 2)
		  and r10_marca     = 'POWERS'
		  and not exists
			(select 1 from t4
	...
	unload to "eli_item_pow06_11.unl"
		select * from sermaco_gm@segye01:rept011
			where r11_compania in (1, 2)
			  and exists
				(select 1 from t5
					where t5.item = r11_item);

	delete from sermaco_gm@segye01:rept011
		where r11_compania in (1, 2)
		  and exists
			(select 1 from t5
				where t5.item = r11_item);

	delete from sermaco_gm@segye01:rept010
		where r10_compania in (1, 2)
		  and r10_marca     = 'POWERS'
		  and not exists
			(select 1 from t4
	...
	unload to "eli_item_pow07_11.unl"
		select * from sermaco_qm@seuio01:rept011
			where r11_compania in (1, 2)
			  and exists
				(select 1 from t5
					where t5.item = r11_item);

	delete from sermaco_qm@seuio01:rept011
		where r11_compania in (1, 2)
		  and exists
			(select 1 from t5
				where t5.item = r11_item);

	delete from sermaco_qm@seuio01:rept010
		where r10_compania in (1, 2)
		  and r10_marca     = 'POWERS'
		  and not exists
			(select 1 from t4
