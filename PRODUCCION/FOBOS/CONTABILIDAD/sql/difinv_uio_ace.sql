...
select count(*) tot_t2_fil
	from t2
	where exists (select 1 from acero_qm:rept090
			where r90_compania   = cia
		          and r90_locali_fin = loc
		          and r90_codtra_fin = cod
		          and r90_numtra_fin = num);
drop table t1;
