SELECT (SELECT LPAD(j10_localidad, 2, 0) || " " || TRIM(g02_abreviacion)
		|| " (GM)"
		FROM gent002
...
SELECT (SELECT LPAD(j10_localidad, 2, 0) || " " || TRIM(g02_abreviacion)
	...
	j10_num_fuente AS num_fue,
	j10_codcli AS codcli
	FROM acero_gc:cajt010, acero_gc:cajt011
	WHERE j10_compania     = 1
	  AND j10_localidad    = 2
	  AND j10_tipo_fuente <> "EC"
	  AND j10_estado       = "P"
