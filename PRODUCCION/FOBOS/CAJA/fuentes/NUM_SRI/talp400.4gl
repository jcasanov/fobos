...
FOR i = 1 TO num_ord
	...
	END FOR
END FOR
LET query = 'SELECT fecha_tran, ord_t, num_tran, nomcli, valor_mo, valor_oc, ',
			'valor_fa, valor_vi, valor_br, valor_de, ',
			'(valor_br - valor_de) subtotal, valor_im, ',
			'(valor_br - valor_de + valor_im) valor_tot, est ',
...
LET query = "INSERT INTO tmp_det ",
		...
		" CASE WHEN t23_estado = 'F' ",
			" THEN t23_val_mo_tal ",
			" ELSE t23_val_mo_tal ", factor CLIPPED,
		" END, ",
		...
		" CASE WHEN t23_estado = 'F' ",
			" THEN t23_tot_dscto ",
			" ELSE t23_tot_dscto ", factor CLIPPED,
		" END + ",
		retorna_expr_inv(tr_ant, 1) CLIPPED, ", ",
		" CASE WHEN t23_estado = 'F' ",
			" THEN t23_val_impto ",
