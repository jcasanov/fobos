...
LET filas_max  = 100
OPEN WINDOW w_tarj AT 06, 38 WITH 15 ROWS, 41 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW w_guia AT 06, 38 WITH 15 ROWS, 41 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_cobra AT 06, 26 WITH 15 ROWS, 53 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_mectal AT 06, 40 WITH 15 ROWS, 39 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_cligen AT 06, 28 WITH 15 ROWS, 51 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_ordtal AT 06, 26 WITH 15 ROWS, 53 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
FUNCTION fl_ayuda_tempario(cod_cia)
...
OPEN WINDOW w_tarea AT 06, 14 WITH 15 ROWS, 65 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW wh_hoc AT 06, 50 WITH 15 ROWS, 29 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_pretal AT 06, 30 WITH 15 ROWS, 49 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
DECLARE q_pretal1 CURSOR FOR
        SELECT t20_numpre, t20_cod_cliente, t20_nom_cliente 
		FROM talt020
...
IF i = 0 THEN
        ...
        RETURN 	rh_pretal[1].t20_numpre, rh_pretal[1].t20_cod_cliente,
		rh_pretal[1].t20_nom_cliente
END IF
IF vg_gui = 0 THEN
	MESSAGE "                      "
END IF
...
END IF
LET  i = arr_curr()
        RETURN 	rh_pretal[i].t20_numpre, rh_pretal[i].t20_cod_cliente,
		rh_pretal[i].t20_nom_cliente
...
OPEN WINDOW w_provee AT 06, 32 WITH 15 ROWS, 47 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
WHILE TRUE
	...
	END IF
	MESSAGE 'Seleccionando datos . . . espere por favor.'
	LET query = "SELECT p01_codprov, p01_nomprov FROM cxpt001 ",
...
OPEN WINDOW w_factal AT 06, 32 WITH 15 ROWS, 47 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_favorcob AT 06, 12 WITH 15 ROWS, 67 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_forpago AT 06, 49 WITH 15 ROWS, 30 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_cajas AT 06, 46 WITH 15 ROWS, 33 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_provloc AT 06, 32 WITH 15 ROWS, 47 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_numfue AT 06, 18 WITH 15 ROWS, 61 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_transac AT 06, 16 WITH 15 ROWS, 63 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_liqrep AT 06, 61 WITH 15 ROWS, 18 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW w_ordcom AT 06, 02 WITH 15 ROWS, 77 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET filas_max  = 100
OPEN WINDOW wh_favortes AT 06, 19 WITH 15 ROWS, 60 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
OPEN WINDOW wh_ret AT 06, 44 WITH 15 ROWS, 35 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET salir = 0
WHILE NOT salir
	LET query = "SELECT n03_proceso, n03_nombre FROM rolt003 ",
				" WHERE n03_estado = 'A'", " AND ", 
				 expr_sql CLIPPED ,
                    'ORDER BY ', vm_columna_1, ' ', rm_orden[vm_columna_1],
                           ', ', vm_columna_2, ' ', rm_orden[vm_columna_2]
...
WHILE TRUE
	...
	IF int_flag THEN
		...
		RETURN rh_electrico[1].r74_electrico,  
		       rh_electrico[1].r74_descripcion  
	END IF
	MESSAGE 'Seleccionando datos . . . espere por favor.'
...
DEFINE rh_grupoact ARRAY[1000] OF RECORD
...
FUNCTION fl_ayuda_tipo_activo(cod_cia)
...
OPEN WINDOW w_tipoact AT 06, 37 WITH 15 ROWS, 42 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
LET salir = 0
WHILE NOT salir
	LET query = "SELECT a02_tipo_act, a02_nombre FROM actt002 ",
				" WHERE a02_compania = ", cod_cia," AND ", 
				 expr_sql CLIPPED ,
                    'ORDER BY ', vm_columna_1, ' ', rm_orden[vm_columna_1],
                           ', ', vm_columna_2, ' ', rm_orden[vm_columna_2]
...
FUNCTION fl_ayuda_codigo_bien(cod_cia)

DEFINE rh_codigo_bien ARRAY[1000] OF RECORD
...
OPEN WINDOW w_codigo_bien AT 06, 37 WITH 15 ROWS, 42 COLUMNS
        ATTRIBUTE(FORM LINE FIRST, COMMENT LINE OFF, MESSAGE LINE LAST, BORDER)
IF vg_gui = 1 THEN
...
--#DISPLAY 'Código'       	 TO bt_codigo_bien
--#DISPLAY 'Descripcion'	 TO bt_descripcion
...
LET salir = 0
WHILE NOT salir
	LET query = "SELECT a10_codigo_bien, a10_descripcion FROM actt010 ",
				" WHERE a10_compania = ", cod_cia," AND ", 
				 expr_sql CLIPPED ,
                    'ORDER BY ', vm_columna_1, ' ', rm_orden[vm_columna_1],
                           ', ', vm_columna_2, ' ', rm_orden[vm_columna_2]
...
FUNCTION fl_ayuda_presupuestos_taller(cod_cia, cod_loc, estado)
DEFINE rh_pretal ARRAY[1000] OF RECORD
        t20_numpre              LIKE talt020.t20_numpre,
        t20_cod_cliente         LIKE talt020.t20_cod_cliente,
        t20_nom_cliente         LIKE talt020.t20_nom_cliente
        END RECORD
...
WHILE TRUE
	...
	IF int_flag THEN
		...
		RETURN rh_identidad[1].n16_flag_ident,
			rh_identidad[1].n16_descripcion
	END IF
	MESSAGE 'Seleccionando datos . . . espere por favor.'
	LET vm_columna_1           = 1
	LET vm_columna_2           = 2
...
WHILE TRUE
	...
	IF int_flag THEN
		...
		RETURN rh_sectorial[1].n17_sectorial,
...
WHILE TRUE
	...
	IF int_flag THEN
		...
		RETURN rh_rubro_club[1].n67_cod_rubro,
			rh_rubro_club[1].n67_nombre
	END IF
	CASE estado
		WHEN 'A'
