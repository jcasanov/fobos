...
load from "act_reval_qm.unl" insert into tmp_rev;

delete from tmp_rev where estado = 'D';

delete from tmp_rev where codigo in (9, 14, 228, 182, 199, 200, 207, 222, 223);
...
load from "act_nue_uio.unl" insert into t1;
