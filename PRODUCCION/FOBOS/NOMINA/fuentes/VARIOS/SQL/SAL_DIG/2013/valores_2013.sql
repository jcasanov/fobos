SELECT EXTEND(MDY(n32_mes_proceso,01,n32_ano_proceso),YEAR TO MONTH) AS fecha,
	...
	CASE WHEN n32_mes_proceso = 4
		...
		ELSE 0.00
	END AS utilidades,
	CASE WHEN n30_estado = "A" OR n32_cod_trab IN (134, 174)
	...
	ROUND((NVL(CASE WHEN n30_estado = "A" OR
			n32_cod_trab IN (112, 134, 170, 174, 191, 176, 186,
					119, 130, 139)
			THEN
