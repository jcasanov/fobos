select n56_compania cia, 64 rubro, n30_cod_trab cod_trab, n30_nombres empleado,
...
select cia compa, cod_trab emp, trim('11240104' || cuenta[9, 11]) cta,
	trim('C.T.VACACIONES ' || empleado[1, 25]) descripcion, 'A' est_c,
