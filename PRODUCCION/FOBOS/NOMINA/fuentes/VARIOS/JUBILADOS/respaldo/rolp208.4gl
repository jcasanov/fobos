...
FOREACH q_pt INTO r_n30.*
	CALL lee_reg_jub2(r_n01.n01_ano_proceso, r_n01.n01_mes_proceso,
				r_n30.n30_cod_trab)
		RETURNING r_n48_2.*
...
END IF
LET r_b12.b12_fec_proceso = MDY(rm_par.n48_mes_proceso, 01,
				rm_par.n48_ano_proceso) + 1 UNITS MONTH
				- 1 UNITS DAY
IF TODAY < r_b12.b12_fec_proceso THEN
	LET r_b12.b12_fec_proceso = TODAY
END IF
LET r_b12.b12_num_comp    = fl_numera_comprobante_contable(vg_codcia,
				r_b12.b12_tipo_comp,YEAR(r_b12.b12_fec_proceso),
