...
case mes
	when '01'
	       load from "VENTAS2006/upcliente200601.txt" insert into te_cliente
	when '02'
	       load from "VENTAS2006/upcliente200602.txt" insert into te_cliente
	when '03'
	       load from "VENTAS2006/upcliente200603.txt" insert into te_cliente
	when '04'
	       load from "VENTAS2006/upcliente200604.txt" insert into te_cliente
	when '05'
	       load from "VENTAS2006/upcliente200605.txt" insert into te_cliente
	when '06'
	       load from "VENTAS2006/upcliente200606.txt" insert into te_cliente
	when '07'
	       load from "VENTAS2006/upcliente200607.txt" insert into te_cliente
	when '08'
	       load from "VENTAS2006/upcliente200608.txt" insert into te_cliente
	when '09'
	       load from "VENTAS2006/upcliente200609.txt" insert into te_cliente
	when '10'
	       load from "VENTAS2006/upcliente200610.txt" insert into te_cliente
	when '11'
	       load from "VENTAS2006/upcliente200611.txt" insert into te_cliente
	when '12'
	       load from "VENTAS2006/upcliente200612.txt" insert into te_cliente
end case
