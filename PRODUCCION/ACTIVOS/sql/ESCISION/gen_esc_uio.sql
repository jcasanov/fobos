...
INSERT INTO tmp_a12
	...
	a.val_d_p, a.val_alt, "DC", "13012384", "E1CRIPAU",
	"2013-01-13 00:00:00"
	FROM tmp_act a
	WHERE a.grp_act <> 1
...
INSERT INTO tmp_a12
	...
	SELECT a.cia, "DP", 0, a.acti, a.ref, a.loc_o, a.dep_o, a.loc_d,
		...
		"13012384", "E1CRIPAU", "2013-01-13 00:00:00"
	FROM tmp_act a
	WHERE a.grp_act <> 1
...
INSERT INTO t1
	...
	SELECT a.cia, "ES", 0, a.acti, "BAJA POR ESCISION DEL ACTIVO.",
		...
		a.val_act, a.val_alt, "DC", "13012385", "E1CRIPAU",
		"2013-01-13 00:00:00"
	FROM tmp_act a;
