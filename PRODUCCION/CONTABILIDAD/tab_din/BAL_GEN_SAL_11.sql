...
SELECT ctbt013.* FROM ctbt013, ctbt012
	WHERE b13_compania     = 1
	  AND b13_fec_proceso <= MDY(12, 31, 2011)
...
SELECT cia, b13_cuenta AS cta_mov, mon, 2012 AS anio, 6 AS nive,
...
UPDATE tmp_mov
	SET val_db = 0,
	    val_cr = 668995.19
	WHERE cta_mov LIKE '3104%'
	  AND cta_mov <> '31040101001';
--}

DELETE FROM t_bal_gen
	WHERE b11_compania = 1
	  AND b11_ano      = 2012;

INSERT INTO t_bal_gen
	SELECT cia, cta_mov, mon, anio, val_db, val_cr
		FROM tmp_mov;
