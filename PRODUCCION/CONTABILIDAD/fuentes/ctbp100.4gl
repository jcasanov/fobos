...
DEFINE rm_b10			RECORD LIKE ctbt000.*
...
INITIALIZE rm_b10.*, r_mon.* TO NULL
CLEAR tit_mon_bas, tit_mon_alt, tit_cta_pre, tit_cta_ant, tit_cta_dfi,
	tit_cta_dfe, tit_cia_des
LET rm_b10.b00_moneda_base = rg_gen.g00_moneda_base
CALL fl_lee_moneda(rm_b10.b00_moneda_base) RETURNING r_mon.*
...
LET rm_b10.b00_modi_compau = 'N'
LET rm_b10.b00_estado      = 'A'
CALL muestra_estado()
CALL leer_datos('I')
IF NOT int_flag THEN
	INSERT INTO ctbt000 VALUES (rm_b10.*)
...
WHENEVER ERROR STOP
UPDATE ctbt000
		SET b00_moneda_base = rm_b10.b00_moneda_base,
		    b00_moneda_aux = rm_b10.b00_moneda_aux,
		    b00_periodo_ini = rm_b10.b00_periodo_ini,
		    b00_periodo_fin = rm_b10.b00_periodo_fin,
		    b00_inte_online = rm_b10.b00_inte_online,
		    b00_mayo_online = rm_b10.b00_mayo_online,
		    b00_modi_compma = rm_b10.b00_modi_compma,
			b00_modi_compau = rm_b10.b00_modi_compau,
			b00_cuenta_uti = rm_b10.b00_cuenta_uti,
			b00_cta_uti_ant = rm_b10.b00_cta_uti_ant,
			b00_cuenta_difi = rm_b10.b00_cuenta_difi,
			b00_cuenta_dife = rm_b10.b00_cuenta_dife
...
DISPLAY BY NAME rm_b10.b00_moneda_base, rm_b10.b00_periodo_ini
LET int_flag = 0
INPUT BY NAME rm_b10.b00_compania, rm_b10.b00_moneda_base,
	rm_b10.b00_moneda_aux, rm_b10.b00_periodo_ini, rm_b10.b00_periodo_fin,
	rm_b10.b00_inte_online, rm_b10.b00_mayo_online, rm_b10.b00_modi_compma,
	rm_b10.b00_modi_compau, rm_b10.b00_anopro, 
	rm_b10.b00_fecha_cd, rm_b10.b00_fecha_cm, rm_b10.b00_fecha_ca,
        rm_b10.b00_cuenta_uti, rm_b10.b00_cta_uti_ant,
	rm_b10.b00_cuenta_difi, rm_b10.b00_cuenta_dife
	WITHOUT DEFAULTS
	ON KEY(INTERRUPT)
	        IF field_touched(rm_b10.b00_compania, rm_b10.b00_moneda_base,
 			rm_b10.b00_moneda_aux, rm_b10.b00_periodo_ini,
			rm_b10.b00_periodo_fin, rm_b10.b00_inte_online,
			rm_b10.b00_mayo_online, rm_b10.b00_modi_compma,
			rm_b10.b00_modi_compau, rm_b10.b00_cuenta_uti,
			rm_b10.b00_cta_uti_ant, rm_b10.b00_cuenta_difi,
			rm_b10.b00_cuenta_dife)
	        THEN
	               	LET int_flag = 0
	...
	ON KEY(F2)
		IF INFIELD(b00_compania) THEN
			...
			IF cod_cia_aux IS NOT NULL THEN
				CALL fl_lee_compania(cod_cia_aux)
					RETURNING rg_cia.*
				LET rm_b10.b00_compania = cod_cia_aux
				DISPLAY BY NAME rm_b10.b00_compania 
		...
		IF INFIELD(b00_moneda_base) THEN
			...
			LET int_flag = 0
			IF mone_aux IS NOT NULL THEN
				LET rm_b10.b00_moneda_base = mone_aux
				DISPLAY BY NAME rm_b10.b00_moneda_base 
				DISPLAY nomm_aux TO tit_mon_bas
			END IF 
		END IF
		IF INFIELD(b00_moneda_aux) THEN
			...
			LET int_flag = 0
			IF mone_aux IS NOT NULL THEN
				LET rm_b10.b00_moneda_aux = mone_aux
				DISPLAY BY NAME rm_b10.b00_moneda_aux 
				DISPLAY nomm_aux TO tit_mon_alt
			END IF 
		END IF
		IF INFIELD(b00_cuenta_uti) THEN
			...
			LET int_flag = 0
			IF cod_aux IS NOT NULL THEN
				LET rm_b10.b00_cuenta_uti = cod_aux
				DISPLAY BY NAME rm_b10.b00_cuenta_uti 
				DISPLAY nom_aux TO tit_cta_pre
			END IF 
		END IF
		IF INFIELD(b00_cta_uti_ant) THEN
			...
			LET int_flag = 0
			IF cod_aux IS NOT NULL THEN
				LET rm_b10.b00_cta_uti_ant = cod_aux
				DISPLAY BY NAME rm_b10.b00_cta_uti_ant 
				DISPLAY nom_aux TO tit_cta_ant
			END IF 
		END IF
		IF INFIELD(b00_cuenta_difi) THEN
			...
			LET int_flag = 0
			IF cod_aux IS NOT NULL THEN
				LET rm_b10.b00_cuenta_difi = cod_aux
				DISPLAY BY NAME rm_b10.b00_cuenta_difi 
				DISPLAY nom_aux TO tit_cta_dfi
			END IF 
		END IF
		IF INFIELD(b00_cuenta_dife) THEN
			...
			LET int_flag = 0
			IF cod_aux IS NOT NULL THEN
				LET rm_b10.b00_cuenta_dife = cod_aux
				DISPLAY BY NAME rm_b10.b00_cuenta_dife 
				DISPLAY nom_aux TO tit_cta_dfe
			END IF 
		END IF
	...
	AFTER FIELD b00_compania
		IF rm_b10.b00_compania IS NOT NULL THEN
			CALL fl_lee_compania(rm_b10.b00_compania)
		 		RETURNING rg_cia.*
			...
			IF rg_cia.g01_estado = 'B' THEN
                                ...
                                NEXT FIELD b00_compania
                        END IF		 
			CALL fl_lee_compania_contabilidad(rm_b10.b00_compania)
                        	RETURNING r_ctb_aux.*
			IF rm_b10.b00_compania = r_ctb_aux.b00_compania THEN
	...
	AFTER FIELD b00_moneda_base 
		IF rm_b10.b00_moneda_base IS NOT NULL THEN
			CALL fl_lee_moneda(rm_b10.b00_moneda_base)
				RETURNING r_mon.* 
			IF r_mon.g13_moneda IS NULL  THEN
	...
	AFTER FIELD b00_moneda_aux 
		IF rm_b10.b00_moneda_aux IS NOT NULL THEN
			CALL fl_lee_moneda(rm_b10.b00_moneda_aux)
				RETURNING r_mon.* 
			IF r_mon.g13_moneda IS NULL  THEN
				CALL fgl_winmessage(vg_producto,'Moneda no existe.','exclamation')
	...
	AFTER FIELD b00_periodo_fin
		IF rm_b10.b00_periodo_fin IS NOT NULL THEN
			IF rm_b10.b00_periodo_fin <= rm_b10.b00_periodo_ini THEN
	...
	AFTER FIELD b00_anopro 
		IF flag_mant = 'M' THEN
			LET rm_b10.b00_anopro = r_ori.b00_anopro
			DISPLAY BY NAME rm_b10.b00_anopro
		ELSE
			LET rm_b10.b00_fecha_ca=MDY(12,31,rm_b10.b00_anopro -1)
			DISPLAY BY NAME rm_b10.b00_fecha_ca
		END IF
	AFTER FIELD b00_fecha_cd
		IF flag_mant = 'M' THEN
			LET rm_b10.b00_fecha_cd = r_ori.b00_fecha_cd
			DISPLAY BY NAME rm_b10.b00_fecha_cd
		END IF
	AFTER FIELD b00_fecha_cm
		IF flag_mant = 'M' THEN
			LET rm_b10.b00_fecha_cm = r_ori.b00_fecha_cm
			DISPLAY BY NAME rm_b10.b00_fecha_cm
		END IF
	AFTER FIELD b00_fecha_ca
		IF flag_mant = 'M' THEN
			LET rm_b10.b00_fecha_ca = r_ori.b00_fecha_ca
			DISPLAY BY NAME rm_b10.b00_fecha_ca
		END IF
	AFTER FIELD b00_cuenta_uti 
		IF rm_b10.b00_cuenta_uti IS NOT NULL THEN
			CALL fl_lee_cuenta(rm_b10.b00_compania,
						rm_b10.b00_cuenta_uti)
				RETURNING r_cta.*
	...
	AFTER FIELD b00_cta_uti_ant 
		IF rm_b10.b00_cta_uti_ant IS NOT NULL THEN
			CALL fl_lee_cuenta(rm_b10.b00_compania,
						rm_b10.b00_cta_uti_ant)
				RETURNING r_cta.*
			IF r_cta.b10_cuenta IS NULL  THEN
				CALL fgl_winmessage(vg_producto,'Cuenta no existe para esta compañía.','exclamation')
	...
	AFTER FIELD b00_cuenta_difi 
		IF rm_b10.b00_cuenta_difi IS NOT NULL THEN
			CALL fl_lee_cuenta(rm_b10.b00_compania,
						rm_b10.b00_cuenta_difi)
				RETURNING r_cta.*
			IF r_cta.b10_cuenta IS NULL  THEN
				CALL fgl_winmessage(vg_producto,'Cuenta no existe para esta compañía.','exclamation')
	...
	AFTER FIELD b00_cuenta_dife 
		IF rm_b10.b00_cuenta_dife IS NOT NULL THEN
			CALL fl_lee_cuenta(rm_b10.b00_compania,
						rm_b10.b00_cuenta_dife)
				RETURNING r_cta.*
			IF r_cta.b10_cuenta IS NULL  THEN
...
IF vm_num_rows > 0 THEN
	SELECT * INTO rm_b10.* FROM ctbt000 WHERE ROWID=num_registro	
	IF STATUS = NOTFOUND THEN
		CALL fgl_winmessage (vg_producto,'No existe registro con índice: ' || vm_row_current,'exclamation')
		RETURN
	END IF
	DISPLAY BY NAME rm_b10.b00_compania, rm_b10.b00_moneda_base,
		rm_b10.b00_moneda_aux, rm_b10.b00_periodo_ini,
		rm_b10.b00_periodo_fin, rm_b10.b00_inte_online,
		rm_b10.b00_mayo_online, rm_b10.b00_modi_compma,
		rm_b10.b00_modi_compau, rm_b10.b00_cuenta_uti,
		rm_b10.b00_cta_uti_ant, rm_b10.b00_cuenta_difi,
		rm_b10.b00_cuenta_difi, rm_b10.b00_anopro,
		rm_b10.b00_fecha_cd, rm_b10.b00_fecha_cm, rm_b10.b00_fecha_ca
	CALL fl_lee_compania(rm_b10.b00_compania) RETURNING rg_cia.*
	DISPLAY rg_cia.g01_razonsocial TO tit_cia_des
	CALL fl_lee_moneda(rm_b10.b00_moneda_base) RETURNING r_mon.* 
	DISPLAY r_mon.g13_nombre TO tit_mon_bas
	CALL fl_lee_moneda(rm_b10.b00_moneda_aux) RETURNING r_mon.* 
	DISPLAY r_mon.g13_nombre TO tit_mon_alt
	CALL fl_lee_cuenta(rm_b10.b00_compania,rm_b10.b00_cuenta_uti)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cta_pre
	CALL fl_lee_cuenta(rm_b10.b00_compania,rm_b10.b00_cta_uti_ant)
 		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cta_ant
	CALL fl_lee_cuenta(rm_b10.b00_compania,rm_b10.b00_cuenta_difi)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cta_dfi
	CALL fl_lee_cuenta(rm_b10.b00_compania,rm_b10.b00_cuenta_dife)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cta_dfe
	CALL muestra_estado()
ELSE
...
CALL mostrar_registro(vm_r_rows[vm_row_current])
IF confir = 'Yes' THEN
	LET mensaje = 'Compañía ACTIVADA  Ok.'
ELSE
	LET mensaje = 'Compañía BLOQUEADA  Ok.'
END IF
...
ELSE
	DISPLAY 'BLOQUEADO' TO tit_estado_cia
END IF
DISPLAY rm_b10.b00_estado TO tit_est
