------------------------------------------------------------------------------
-- Titulo           : repp412.4gl - Impresión Ajuste de costos
...
FOREACH q_deto INTO r_r20.*, n_item
	OUTPUT TO REPORT ajuste_costo(r_r20.r20_item,
				     n_item,
				     r_r20.r20_costant_mb,
				     r_r20.r20_costnue_mb,
				     r_r20.r20_stock_ant)
END FOREACH
...
REPORT ajuste_costo(item, descripcion, costo_ant, costo_nue, stock)
...
DEFINE costo_ant	LIKE rept020.r20_costant_mb
DEFINE costo_nue	LIKE rept020.r20_costnue_mb
DEFINE stock 		LIKE rept020.r20_stock_ant
...
PAGE HEADER
	...
	LET documento = 'AJUSTE DE COSTO # ' || rm_r19.r19_num_tran
	...
	SKIP 1 LINES
--	cabecera de la ajuste_costo
	PRINT COLUMN 1, fl_justifica_titulo('I', 'Moneda', 15), ': ', 
			fl_justifica_titulo('I', rm_g13.g13_nombre, 15),
	      COLUMN 75, fl_justifica_titulo('I', 'Fecha Ajuste', 12), ': ', 
...
--
	...
	PRINT COLUMN 1,  'Item',
	      ...
	      COLUMN 55, fl_justifica_titulo('D', 'Stock', 10),
	      COLUMN 65, fl_justifica_titulo('D', 'Costo Anterior', 16),
	      COLUMN 83, fl_justifica_titulo('D', 'Costo Nuevo', 16)
...
ON EVERY ROW
	...
	PRINT COLUMN 1,  item,
	      ...
	      COLUMN 55, stock     USING "##,###,##&",
	      COLUMN 65, costo_ant USING "#,###,###,##&.##",
	      COLUMN 83, costo_nue USING "#,###,###,##&.##"
	
ON LAST ROW
	NEED 2 LINES
	PRINT COLUMN 83, '----------------'
	PRINT COLUMN 71, 'Total Ajuste', 
		         SUM(stock * (costo_nue - costo_ant)) 
		         USING '#,###,###,##&.##'
