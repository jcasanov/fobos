...
CASE vm_imprimir
	WHEN 'I'
		...
		FOREACH q_r82 INTO r_r82.*, cod_desc_item
			OUTPUT TO REPORT rep_nota_pedido(r_r82.*, cod_desc_item)
		END FOREACH
	...
	WHEN 'B'
		...
		FOREACH q_r82 INTO r_r82.*, cod_desc_item
			OUTPUT TO REPORT rep_nota_pedido2(r_r82.*,cod_desc_item)
		END FOREACH
...
LET int_flag = 0
INPUT BY NAME rm_r81.r81_pedido, vm_imprimir
	WITHOUT DEFAULTS
	ON KEY(INTERRUPT)
		LET int_flag = 1
		RETURN
...
DEFINE r_g16, r1_g16, r2_g16	RECORD LIKE gent016.*
...
BEFORE GROUP OF r_r82.r82_partida
	...
	display 'r82_partida ... ', r_r82.r82_partida
--	NOTA DE PEDIDO (INTERNA)
--	OJO SE LE AGREGA LA PARTIDA NACIONAL Y DIGITO VERIFICADOR (RCA)
	IF r_r82.r82_partida[9,11] <> '' OR r_r82.r82_partida[9,11] <> '00' THEN
...
--				r_g16.g16_verifcador
	...
	IF partida[6,10] = '' OR partida[6,10] <> '00.00' THEN
		PRINT COLUMN 027, desc_cap CLIPPED, ' ....'
		display '..'
--		SKIP 1 LINES
		PRINT COLUMN 027, desc_cap6 CLIPPED, ' ....' 
	END IF
	PRINT COLUMN 027, r_nivel.g16_desc_par[001,c1]
	PRINT COLUMN 001, "PARTIDA: ", partida," ", r_g16.g16_desc_par[001,c1]
--	PRINT COLUMN 027,  			    r_g16.g16_desc_par[c2,225]
	...
	PRINT COLUMN 001, "--------------------------------------------------------------------------------------------------------------------------------------------------------------"
	PRINT COLUMN 103, r_g13p.g13_simbolo,
	      COLUMN 120, r_g13p.g13_simbolo,
	      COLUMN 133, r_g13b.g13_simbolo,
	      COLUMN 150, r_g13b.g13_simbolo
...
--              SKIP 1 LINES
	...
	PRINT COLUMN 001, "----------------------------------------------------------------------------------------------------------------------------------------------------------------"
	PRINT COLUMN 130, r_g13p.g13_simbolo,
	      COLUMN 150, r_g13p.g13_simbolo
