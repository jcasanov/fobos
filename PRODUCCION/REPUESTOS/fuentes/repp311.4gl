	...
	AFTER FIELD vm_linea
		IF vm_linea IS NOT NULL THEN
			...
			IF r_r03.r03_codigo IS NULL THEN
				...
				CALL fl_mostrar_mensaje('No existe Linea de Venta en la Compañía.','exclamation')
				NEXT FIELD vm_linea
			ELSE
				DISPLAY r_r03.r03_nombre TO nom_linea
			END IF
	...
	AFTER FIELD vm_rotacion
		IF vm_rotacion IS NOT NULL THEN
			...
			IF r_r04.r04_rotacion IS NULL THEN
				CLEAR nom_rotacion
				--CALL fgl_winmessage(vg_producto,'No existe la Rotaci¢n en la Compañía.','exclamation')
				CALL fl_mostrar_mensaje('No existe la Rotaci¢n en la Compañía.','exclamation')
	...
	AFTER FIELD vm_tipo
		IF vm_tipo IS NOT NULL THEN
			...
			IF r_r06.r06_codigo IS NULL THEN
				CLEAR nom_tipo
				--CALL fgl_winmessage(vg_producto,'No existe el tipo de item en la Companía.','exclamation')
				CALL fl_mostrar_mensaje('No existe el tipo de item en la Companía.','exclamation')
				NEXT FIELD vm_tipo
			ELSE
				DISPLAY r_r06.r06_nombre TO nom_tipo
			END IF
