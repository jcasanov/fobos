{*
 * -- Titulo           : repp418.4gl - Consulta clasificacion ABC
 * -- Elaboracion      : 28-jun-2008
 * -- Autor            : JCM
 * -- Formato Ejecucion: fglrun repp418 base_datos modulo compañía 
 *}
...
DEFINE rm_item ARRAY[30000] OF RECORD
	...
	vtas_anio		DECIMAL(12,2),
	vtas_acumuladas	DECIMAL(12,2),
	porc_ventas		DECIMAL(5,2),
...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/repp418.error')
CALL fgl_init4js()
...
OPEN WINDOW repw418_1 AT 3,2 WITH 22 ROWS, 80 COLUMNS
	ATTRIBUTE(FORM LINE FIRST + 1, COMMENT LINE LAST, MENU LINE FIRST,
		  BORDER, MESSAGE LINE LAST) 
OPEN FORM f_repf418_1 FROM '../forms/repf418_1'
DISPLAY FORM f_repf418_1
...
define	i	integer
	...
	LET query = 'SELECT te_item, r20_cod_tran, r20_precio * r20_cant_ven as valvta',
	  			' FROM temp_item, rept020 ',
