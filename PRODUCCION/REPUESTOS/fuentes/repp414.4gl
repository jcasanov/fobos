------------------------------------------------------------------------------
-- Titulo           : repp414.4gl - Impresion ventas al taller
-- Elaboracion      : 29-dic-2001
-- Autor            : JCM
-- Formato Ejecucion: fglrun repp414 base módulo compañía localidad 
--		      tipo_tran num_tran
-- Ultima Correccion: 
-- Motivo Correccion: 
------------------------------------------------------------------------------
...
PAGE HEADER
	...
	ELSE
		LET documento = 'REQUISICION # ' || rm_r19.r19_num_tran
	END IF
