...
select unique r20_cod_tran, r20_num_tran, r34_num_ord_des from t2 into temp t4;
select count(*) tot_ord_des from t2;
drop table t4;
select unique r20_cod_tran, r20_num_tran, r34_num_ord_des
