...
IF rm_r19.r19_num_tran IS NULL THEN
	--CALL fgl_winmessage(vg_producto,'No existe dev. compra local.','stop')
...
PAGE HEADER
	...
	LET documento = 'COMPROBANTE DEV. COMPRA LOCAL No. ' ||
						rm_r19.r19_num_tran CLIPPED
	...
	PRINT COLUMN 01,  "PROVEEDOR (", rm_c10.c10_codprov
	      ...
	      COLUMN 69,  "FECHA DEVOLUCION   : ", DATE(rm_r19.r19_fecing) 
			 			USING "dd-mm-yyyy"
	...
	PRINT COLUMN 01,  "COMPRA LOCAL      : ", rm_r19.r19_tipo_dev, "-",
						  rm_r19.r19_num_dev
						  USING '<<<<<<<<<&',
