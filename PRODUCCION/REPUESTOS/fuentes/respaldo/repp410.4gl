...
--	print '&k2S' 		-- Letra condensada
	...
	PRINT COLUMN 27,  "ALMACEN : ", rm_loc.g02_nombre,
	      COLUMN 99,  "No. ", rm_r19.r19_cod_tran, " ", factura
	PRINT COLUMN 99,  "FECHA FACTURA : ", DATE(rm_r19.r19_fecing) 
			 			USING "dd-mm-yyyy"
	SKIP 1 LINES
...
--	print '&k2S' 		-- Letra condensada
	...
	ELSE
	PRINT COLUMN 27,  "ALMACEN : ", rm_loc.g02_nombre,
	      COLUMN 70,  "No. ", rm_r19.r19_cod_tran, " ", factura
	PRINT COLUMN 70,  "FECHA FACTURA : ", DATE(rm_r19.r19_fecing) 
			 			USING "dd-mm-yyyy"
	END IF
	SKIP 2 LINES
	PRINT COLUMN 01,  "CLIENTE (", rm_r19.r19_codcli USING "&&&&&", ") : ",
