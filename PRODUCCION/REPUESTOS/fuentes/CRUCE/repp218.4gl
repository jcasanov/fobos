...
SELECT COUNT(r37_item)
	...
	WHERE r34_compania      = r20_compania
	  ...
	  AND EXISTS (SELECT 1 FROM rept020 a
			WHERE a.r20_compania  = r_r19.r19_compania
			  AND a.r20_localidad = r_r19.r19_localidad
			  AND a.r20_cod_tran  = r_r19.r19_cod_tran
			  AND a.r20_num_tran  = r_r19.r19_num_tran
			  AND a.r20_item      = tmp_t1.r20_item)
DROP TABLE tmp_t1
IF contador > 0 THEN
	RETURN 1
ELSE
