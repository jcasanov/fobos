...
CALL fl_lee_cabecera_transaccion_rep(vg_codcia,vg_codloc,vm_cod_tran,vm_factura)
	RETURNING rm_r19.*
...
FOREACH q_rept020 INTO r_r20.*
	...
	CALL fl_lee_marca_rep(vg_codcia, r_r10.r10_marca) RETURNING r_r73.*
...
--	print '&k2S' 		-- Letra condensada
	...
	FOREACH q_forpag INTO r_j11.*
		CASE r_j11.j11_codigo_pago
			WHEN 'EF' LET valor_efec = valor_efec + r_j11.j11_valor
			WHEN 'CH' LET valor_cheq = valor_cheq + r_j11.j11_valor
			WHEN 'RT' LET valor_rete = valor_rete + r_j11.j11_valor
		END CASE
