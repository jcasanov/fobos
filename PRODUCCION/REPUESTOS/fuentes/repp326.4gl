...
UNLOAD TO "../../../tmp/arch326.unl" DELIMITER "	"
	SELECT * FROM t2
		ORDER BY 3 ASC, 7 ASC, 4 DESC, 5 ASC
DROP TABLE t2
RUN 'echo "LOC	MARCA	FILTRO	AGT	CODTRAN	NUMTRAN	CODCLI	NOMBRE	FECHA_FACT	FORMAPAGO	FECHA_VCTO	CLASE	NOMBRE_CLASE	CODITEM	NOMBRE_ITEM	CAN_VTA	PVP	POR_DSCTO	MULTIPL	FEC_PAGO	VAL_DSCTO	VAL_VTA	FAC_ANT	FECH_ANT	TIPODEV	NUMDEV	" > ../../../tmp/cab326.unl'
