...
IF arg_val(2) = 2 OR arg_val(3) = "T" THEN
	CALL igualar_rept011_todos_servidores('acero_gc','ACGYE01',2,'acero_gm',
						serv_loc)
	CALL igualar_rept011_todos_servidores('acero_gc','ACGYE01',2,'acero_qm',
						'ACUIO01')
	CALL igualar_rept011_todos_servidores('acero_gc','ACGYE01',2,'acero_qs',
						'ACUIO02')
END IF
