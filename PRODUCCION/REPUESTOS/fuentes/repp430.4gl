...
DEFINE aux		LIKE rept019.r19_cont_cred

LET aux = rm_par.cont_cred
INITIALIZE rm_par.* TO NULL
DISPLAY BY NAME rm_par.*
LET rm_par.cont_cred = aux
DISPLAY BY NAME rm_par.cont_cred
...
THEN
	IF rm_par.cont_cred <> 'T' THEN
		LET expr_cr = '  AND r19_cont_cred = "', rm_par.cont_cred, '"'
	END IF
END IF
