------------------------------------------------------------------------------
-- Titulo           : repp401.4gl - Impresión Devolución Factura
...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/repp401.error')
CALL fgl_init4js()
...
PAGE HEADER
	...
	LET documento = 'DEVOLUCION FACTURA # ' || rm_r19.r19_num_tran
...
--	cabecera de la devolucion  
	PRINT COLUMN 1, fl_justifica_titulo('I', 'Factura Devuelta', 16), ': ', 
			rm_r19.r19_tipo_dev, '-', 
			fl_justifica_titulo('I', rm_r19.r19_num_dev, 13),
	...
	PRINT COLUMN 1, fl_justifica_titulo('I', 'Cliente', 16), ': ',  
	      ...
	      COLUMN 72, fl_justifica_titulo('I', 'Moneda', 18), ': ',
	      		rm_g13.g13_nombre
	PRINT COLUMN 1, fl_justifica_titulo('I', 'Vendedor', 16), ': ',
