...
PAGE HEADER
	...
	LET documento = "COMPROBANTE " || tipo_docum || " FACTURA No. " ||
		       rm_r19.r19_cod_tran || "-" || rm_r19.r19_num_tran CLIPPED
	...
	SKIP 1 LINES
	PRINT COLUMN 01,  "FACTURA ", tipo_docum2, sep_pun, rm_r19.r19_tipo_dev,
					 '-', factura,
	      COLUMN 70,  "FECHA ", tipo_docum, sep_pun, DATE(rm_r19.r19_fecing)
						USING "dd-mm-yyyy"
