...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/repp410_2.error')
CALL fgl_init4js()
...
PAGE HEADER
	...
	PRINT COLUMN 20, fl_justifica_titulo('I', rm_r19.r19_num_tran CLIPPED, 15),
	      COLUMN 97, DATE(rm_r19.r19_fecing) USING 'dd-mm-yyyy', 1 SPACES, TIME 
	PRINT COLUMN 20, rm_r19.r19_nomcli CLIPPED,
	      COLUMN 97, rm_r19.r19_cedruc 
	...
	PRINT COLUMN 20, rm_r19.r19_referencia CLIPPED

	SKIP 5 LINES

ON EVERY ROW
	PRINT COLUMN 5,   cod CLIPPED, 
	      COLUMN 23,  descrip CLIPPED,
	      COLUMN 65,  ubic[1,8] CLIPPED,
