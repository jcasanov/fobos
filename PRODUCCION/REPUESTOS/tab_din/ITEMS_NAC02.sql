SELECT (SELECT LPAD(g02_localidad, 2, 0) || " " || g02_abreviacion
		FROM acero_gc@acgyede:gent002
		WHERE g02_compania  = r10_compania
		  AND g02_localidad = 2) AS loc,
	...
	NVL((SELECT SUM(r11_stock_act)
		FROM acero_gc@acgyede:rept011,
			acero_gc@acgyede:rept002
	...
	FROM acero_gc@acgyede:rept010,
		acero_gc@acgyede:rept072
