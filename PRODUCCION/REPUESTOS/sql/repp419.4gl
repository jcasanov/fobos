...
DEFINE acumula_peso	LIKE rept010.r10_peso
...
PAGE HEADER
	...
	PRINT COLUMN 01, '   Atencion a: ', rm_r21.r21_atencion CLIPPED,
	      COLUMN 75, '          Fecha: ', TODAY USING 'dd-mm-yyyy', 
					      1 SPACES, TIME 
	...
	PRINT COLUMN 01, '     Telefono: ', rm_r21.r21_telcli CLIPPED,
	      COLUMN 77, 'Forma de Pago: ',rm_r21.r21_forma_pago 
...
ON EVERY ROW
	...
	PRINT COLUMN 01, vm_lin USING '##',
	      ...
	      COLUMN 82, dscto     USING "#&.##",
	      COLUMN 88, precio    USING "###,###,##&.##",
	      COLUMN 104, (subtotal * (1 - (dscto / 100))) USING "###,###,##&.##"
...
ON LAST ROW
	...
	PRINT COLUMN 89, 'Total Bruto: ', 
	      COLUMN 102, rm_r21.r21_tot_bruto  USING '#,###,###,##&.##'
	
	PRINT COLUMN 89, 'Total Dscto: ', 
	      COLUMN 102, rm_r21.r21_tot_dscto USING '#,###,###,##&.##'

	PRINT COLUMN 102, '================'

	PRINT COLUMN 89, '   Subtotal: ',
	      COLUMN 102, (rm_r21.r21_tot_bruto - rm_r21.r21_tot_dscto) 
				USING '#,###,###,##&.##'

	PRINT COLUMN 97, rg_gen.g00_label_impto,': ', 
	      COLUMN 85, impuesto USING '#,###,###,##&.##'

	PRINT COLUMN 65, 'Peso: ', acumula_peso USING '#,##&.###', ' Kg.',
	      COLUMN 90, 'Total Neto: ', 
	      COLUMN 102, rm_r21.r21_tot_neto USING '#,###,###,##&.##'
END REPORT
