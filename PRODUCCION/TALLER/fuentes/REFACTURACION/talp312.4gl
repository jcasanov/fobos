--------------------------------------------------------------------------------
-- Titulo           : talp312.4gl - Consulta de Refacturación Taller
-- Elaboracion      : 17-mar-2006
-- Autor            : NPC
-- Formato Ejecucion: fglrun talp312 base modulo compañía localidad
-- Ultima Correccion: 
-- Motivo Correccion: 
--------------------------------------------------------------------------------
...
LET comando = 'cd ..', vg_separador, '..', vg_separador, 'TALLER',
	...
	' ', vg_modulo, ' ', vg_codcia, ' ', vg_codloc, ' ', num_fact, ' "F"'
RUN comando	
