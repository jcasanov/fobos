DEFINE vm_dias		INTEGER


MAIN

	LET vm_dias = fp_dias360(MDY(01,01,2014), MDY(12,31,2014), 1)
	DISPLAY vm_dias
	LET vm_dias = fp_dias360(MDY(01,01,2014), MDY(12,31,2014), 0)
	DISPLAY vm_dias
	LET vm_dias = fp_dias360(MDY(05,24,2014), MDY(09,14,2014), 1)
	DISPLAY vm_dias
	LET vm_dias = fp_dias360(MDY(05,24,2014), MDY(09,14,2014), 0)
	DISPLAY vm_dias
...
FUNCTION fp_dias360 (fecha_ini, fecha_fin, metodo)
DEFINE fecha_ini, fecha_fin	DATE
DEFINE metodo			SMALLINT
DEFINE fec1, fec2		DATE
DEFINE fec_txt			CHAR(10)
DEFINE num_anio, num_mes, dias	INTEGER
...
IF metodo = 0 THEN
	LET fec2 = MDY(MONTH(fecha_fin), 01, YEAR(fecha_fin)) + 1 UNITS MONTH
			- 1 UNITS DAY
