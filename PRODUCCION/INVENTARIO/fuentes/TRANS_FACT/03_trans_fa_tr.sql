...
--------------------------------------------------------------------------------
--               TRANSMITIENDO FACTURAS DE QUITO A GUAYAQUIL                  --
--------------------------------------------------------------------------------
...
BEGIN WORK;
	...
	--INSERT INTO acero_gm@acuiopr:rept091
		--SELECT * FROM acero_qm@idsuio01:rept019
		SELECT * FROM acero_qm@acgyede:rept019
		--SELECT * FROM acero_qm@acuiopr:rept019
			WHERE EXISTS
	...
	--INSERT INTO acero_gm@acuiopr:rept092
		--SELECT * FROM acero_qm@idsuio01:rept020
		SELECT * FROM acero_qm@acgyede:rept020
		--SELECT * FROM acero_qm@acuiopr:rept020
			WHERE EXISTS
				(SELECT 1 FROM tmp_fact
...
--------------------------------------------------------------------------------
--                 TRANSMITIENDO FACTURAS DE QUITO AL SUR                     --
--------------------------------------------------------------------------------
