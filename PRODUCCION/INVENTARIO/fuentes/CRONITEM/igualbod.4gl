...
CALL igualar_bodegas_todos_servidores('acero_gc', 'ACGYE01', 2, 'acero_gm',
					serv_loc)
CALL igualar_bodegas_todos_servidores('acero_gc', 'ACGYE01', 2, 'acero_qm',
					'ACUIO01')
CALL igualar_bodegas_todos_servidores('acero_gc', 'ACGYE01', 2, 'acero_qs',
					'ACUIO02')
