...
DEFINE d		SMALLINT
DEFINE r_menu_rep2	ARRAY[22] OF RECORD
				opcion  CHAR(40)
			END RECORD
DEFINE a_c_2, s_c_2     SMALLINT
...
LET r_menu_rep2[19].opcion	= "Inventario Fis. 2005"
LET r_menu_rep2[20].opcion	= "Pedido Prov. Locales"
LET r_menu_rep2[21].opcion	= "Traspaso a La Prensa" 		
LET r_menu_rep2[22].opcion	= "SALIR" 		
...
DEFINE r_menu_rep4	ARRAY[18] OF RECORD
				opcion  CHAR(40)
		        END RECORD
DEFINE a_c_2, s_c_2	SMALLINT
...
LET r_menu_rep4[14].opcion	= "Inventario Fís. 2004"
...
LET r_menu_rep4[18].opcion	= "SALIR"
...
DEFINE r_menu_rep5 ARRAY[10] OF RECORD
                opcion  CHAR(40)
        END RECORD
DEFINE a_c_2, s_c_2         SMALLINT
...
LET r_menu_rep5[10].opcion	= "SALIR"
...
DEFINE r_menu_cob2 ARRAY[12] OF RECORD
                opcion  CHAR(40)
        END RECORD
DEFINE a_c_2, s_c_2         SMALLINT 
...
LET r_menu_cob2[12].opcion      = "SALIR"
...
WHEN 5
	...
	THEN
		EXIT CASE
	END IF
	LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'TESORERIA', vg_separador, 'fuentes', vg_separador, '; fglgo cxpp410 ', vg_base, ' ', 'TE', vg_codcia, vg_codloc
	RUN ejecuta
WHEN 6
	IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia, 'TE',
						'cxpp411')
...
WHEN 2
	...
	THEN
		EXIT CASE
	END IF
	LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COMPRAS', vg_separador, 'fuentes', vg_separador, '; fglgo ordp401 ', vg_base, ' ', 'OC', vg_codcia, vg_codloc
	RUN ejecuta
END CASE
...
DEFINE r_menu_caj2 ARRAY[10] OF RECORD
                opcion  CHAR(40)
        END RECORD
DEFINE a_c_2, s_c_2         SMALLINT
...
LET r_menu_caj2[10].opcion	= "SALIR"	
