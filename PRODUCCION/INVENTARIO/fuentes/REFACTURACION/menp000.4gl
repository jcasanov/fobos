...
CASE c
	...
	WHEN 6
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp111 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	WHEN 7
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
...
'RE', vg_codcia              
	...
	WHEN 11
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp105 ', vg_base, ' ',
'RE'
		RUN ejecuta
	WHEN 12
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
		...
		END IF
	 	LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp106 ', vg_base, ' ',
'RE'
		RUN ejecuta
	WHEN 13
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
...
DISPLAY "Actualización Precios"	TO c800   ## Botón 8  repp222
...
DISPLAY "Refacturación"         TO c2300  ## Botón 20 repp237
DISPLAY "Inventario Fis. 2005"  TO c2400  ## Botón 21 repp239
DISPLAY "Pedido Prov. Locales"  TO c2500  ## Botón 22 repp240
DISPLAY "Traspaso a La Prensa"  TO c2600  ## Botón 23 repp667
...
CASE d
	...
	WHEN 2
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp214 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
	...
	WHEN 4
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp209 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
		RUN ejecuta
	WHEN 5
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
	...
	WHEN 8
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp222 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	{--
	WHEN 9
	...
	WHEN 10
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp221 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	--}
	WHEN 10
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp235 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	WHEN 11
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
...
END CASE
	...
	WHEN 16
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp215 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
		RUN ejecuta
	WHEN 18
...
DISPLAY "Nota de Pedido"  	TO c300   ## Botón 3 repp233
DISPLAY "Confirmación Pedidos" 	TO c400   ## Botón 4 repp205
DISPLAY "Recepción Pedidos" 	TO c500   ## Botón 5 repp206
DISPLAY "Liquidación Pedidos" 	TO c600   ## Botón 6 repp207
DISPLAY "Cierre Pedidos" 	TO c700   ## Botón 7 repp208
...
DISPLAY "Inventario Fís. 2004"   TO c1500  ## Botón 15 repp317
...
CASE g
	...
	WHEN 3
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp305 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	WHEN 4
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
	...
	WHEN 7
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp304 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	WHEN 8
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp313 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
		RUN ejecuta
	WHEN 9
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp312 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
		RUN ejecuta
	WHEN 10
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
	...
	WHEN 11
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp310 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	WHEN 12
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
...
CASE h
	...
	WHEN 1
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp426 ', vg_base, ' ',
'RE', vg_codcia, vg_codloc
		RUN ejecuta
	WHEN 2
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
	...
	WHEN 8
		...
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUES
TOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp404 ', vg_base, ' ',
'RE', vg_codcia, ' ', vg_codloc
		RUN ejecuta
	WHEN 9 
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
...
CASE g
	...
	WHEN 14
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; fglrun cxcp315 ', vg_base, ' ', 'CO', ' ', vg_codcia, ' ', vg_codloc
		RUN ejecuta
	WHEN 0
		CLOSE WINDOW w_menu_consultas
		CALL menu_cobranzas()
...
CASE h
	WHEN 1
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; fglrun cxcp400 ', vg_base, ' ', 'CO', vg_codcia, vg_codloc, ' > cxcp400.txt'
		RUN ejecuta
	WHEN 2
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'CO', 'cxcp401')
	...
	WHEN 7
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; fglrun cxcp416 ', vg_base, ' ', 'CO', vg_codcia, ' ', vg_codloc
	 	RUN ejecuta
	WHEN 8
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'CO', 'cxcp411')
	...
	WHEN 10
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; fglrun cxcp417 ', vg_base, ' ', 'CO', vg_codcia, vg_codloc
	 	RUN ejecuta
	WHEN 0
		CLOSE WINDOW w_menu_reportes
		CALL menu_cobranzas()
...
DISPLAY "Retenciones Proveedor" TO c500   ## Botón 5  cxpp305
...
DISPLAY "Aprobación O. Compras" TO c200   ## Botón 1 ordp201
DISPLAY "Recepción  O. Compras"	TO c300   ## Botón 2 ordp202
DISPLAY "Anulación Recepción"	TO c400   ## Botón 3 ordp204
...
DISPLAY "Mantenimiento Activo"  TO c500   ## Botón 5 actp104
...
--DISPLAY fondo		  	TO c000   ## Picture
DISPLAY "boton_consultas"	TO a      ## Picture 
DISPLAY "Activos Fijos" 	TO c100   ## Botón 1  cxpp300
...
--DISPLAY fondo			TO c000   ## Picture
DISPLAY "boton_configuracion"	TO a      ## Picture 
DISPLAY "Parámetros Compañía"	TO c100   ## Botón 1 rolp100
...
--DISPLAY "Rubros Fijos"  	TO c700   ## Botón 7 rolp106
DISPLAY "Procesos de Roles"  	TO c800   ## Botón 6 rolp107
DISPLAY "Empleados"  		TO c900   ## Botón 7 rolp108
DISPLAY "Sectoriales"  		TO c1000  ## Botón 8 rolp109
DISPLAY "Seguros"  		TO c1100  ## Botón 9 rolp110
DISPLAY "Integración Contable"	TO c1200  ## Botón 10 rolp500
DISPLAY "Sueldos Empleados" 	TO c1300  ## Botón 11 rolp111
...
DISPLAY "boton_transaciones"	TO a      ## Picture  
DISPLAY "Liquidaci¢n Roles"	TO c100   ## Botón 1  menu 
DISPLAY "Anticipos"     	TO c200   ## Botón 2  rolp214
DISPLAY "Cierre Mensual" 	TO c300   ## Botón 3  rolp???
DISPLAY "Liquidaci¢n Decimos"   TO c400   ## Botón 4  menu
...
DISPLAY "Proceso Vacaciones"  	TO c1000  ## Botón 10 rolp252
DISPLAY "Impuesto A La Renta" 	TO c1100  ## Botón 11 rolp250
DISPLAY "Contabilizaci¢n Rol" 	TO c1200  ## Botón 11 rolp501
...
CASE d
	...
	WHEN 5
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'NOMINA', vg_separador, 'fuentes', vg_separador, '; fglrun rolp408 ', vg_base, ' ', 'RO', vg_codcia, ' > aporte_iess.txt'
		RUN ejecuta
	{--
	WHEN 10
	...
	WHEN 6
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'NOMINA', vg_separador, 'fuentes', vg_separador, '; fglrun rolp412 ', vg_base, ' ', 'RO', vg_codcia, ' > fondo_reser.txt'
		RUN ejecuta
	{--
	WHEN 14
	...
	WHEN 7
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'NOMINA', vg_separador, 'fuentes', vg_separador, '; fglrun rolp416 ', vg_base, ' ', 'RO', vg_codcia
		RUN ejecuta
	WHEN 8
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'RO', 'rolp410')
...
DISPLAY "Consulta Liq."   	TO c600   ## Botón 6 rolp303
DISPLAY "Recibo De Pago"   	TO c700   ## Botón 8 rolp303
...
DISPLAY "boton_transaciones"	TO a      ## Picture  
DISPLAY "Proceso"		TO c100   ## Botón 1 rolp???
DISPLAY "Consulta"     		TO c200   ## Botón 2 rolp350

LET d = fgl_getkey()

CASE d
	WHEN 1
call fl_mostrar_mensaje('Proceso esta en construccion.', 'stop')
		--IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
		--					'RO', 'rolp???')
		--THEN
		--	EXIT CASE
		--END IF
--		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'NOMINA', vg_separador, 'fuentes', vg_separador, '; fglrun rolp??? ', vg_base, ' ', 'RO', vg_codcia
--		RUN ejecuta
	WHEN 2
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'RO', 'rolp350')
