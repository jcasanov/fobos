SELECT YEAR(r19_fecing) AS anio,
	...
	(SELECT r72_desc_clase
		FROM acero_qs@idsuio02:rept072
	...
	FROM acero_qs@idsuio02:rept019, acero_qs@idsuio02:rept002,
		acero_qs@idsuio02:rept020, acero_qs@idsuio02:rept010
...
SELECT YEAR(r19_fecing) AS anio,
	...
	(SELECT r72_desc_clase
		...
		WHERE r72_compania   = r10_compania
		  ...
		  AND r72_cod_grupo  = r10_cod_grupo
		  AND r72_cod_clase  = r10_cod_clase) AS clas,
	CASE WHEN r19_cod_tran <> "A-" AND r19_bodega_dest = "DS"
		THEN r20_cant_ven
		ELSE r20_cant_ven * (-1)
	END AS cant,
	CASE WHEN r19_bodega_dest = "DS"
                THEN r19_bodega_dest
                ELSE "DS"
        END AS bode
	FROM acero_qs@idsuio02:rept019, acero_qs@idsuio02:rept020,
		acero_qs@idsuio02:rept010
	WHERE  r19_compania    = 1
	  AND  r19_localidad   = 4
	  AND (r19_bodega_ori  = "DS"
	   OR  r19_bodega_dest = "DS")
	  AND  r20_compania    = r19_compania
	  AND  r20_localidad   = r19_localidad
	  AND  r20_cod_tran    = r19_cod_tran
	  AND  r20_num_tran    = r19_num_tran
