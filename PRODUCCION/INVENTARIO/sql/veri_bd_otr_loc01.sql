...
select r02_localidad loc, r11_bodega bd, r11_item item, r11_stock_act sto_act
	from acero_gm@idsgye01:rept011, acero_gm@idsgye01:rept002
...
insert into t1
	select 2 loc, r11_bodega bd, r11_item item, r11_stock_act sto_act
...
begin work;
	...
	update acero_gm@idsgye01:rept011
		set r11_stock_act = 0,
		    r11_ing_dia    = 0,
		    r11_egr_dia    = 0,
		    r11_tip_ultvta = null,
