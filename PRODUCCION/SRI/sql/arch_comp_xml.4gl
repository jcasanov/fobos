...
MAIN
	...
	IF num_args() <> 6 THEN
		DISPLAY 'Parametros Incorrecto. FALTAN: BASE COMPAÑIA LOCALIDAD AÑO MES ORDEN'
		DISPLAY 'ORDEN: 01. numero retencion'
		DISPLAY '     : 02. modulo'
		DISPLAY '       03. sustento'
		DISPLAY '       04. idtipo'
		DISPLAY '       05. idprov'
		DISPLAY '       06. tc'
		DISPLAY '       07. estableci'
		DISPLAY '       08. pemision'
		DISPLAY '       09. secuencia'
		DISPLAY '       10. aut'
		DISPLAY '       11. fecha_reg'
		DISPLAY '       12. fecha_emi'
		DISPLAY '       13. fecha_cad'
		DISPLAY '       14. base_sin'
		DISPLAY '       15. base_con'
		DISPLAY '       16. base_ice'
		DISPLAY '       17. porc_iva'
		DISPLAY '       18. porc_ice'
		DISPLAY '       19. monto_iva'
		DISPLAY '       20. monto_ice'
		DISPLAY '       21. bienesBase'
		DISPLAY '       22. bienesPorc'
		DISPLAY '       23. bienesValor'
		DISPLAY '       24. serviciosBase'
		DISPLAY '       25. serviciosPorc'
		DISPLAY '       26. serviciosValor'
		DISPLAY '       27. nom_mes'
		DISPLAY '       28. anio_reg'
		DISPLAY '       29. usuario'
		DISPLAY '       30. proveedor'
		DISPLAY '       31. tipo'
		DISPLAY '       32. numero'
		DISPLAY '       33. divid'
		EXIT PROGRAM
...
DEFINE r_doc		RECORD
				num_ret		CHAR(12),
				modulo		CHAR(2),
				sustento	LIKE srit023.s23_sustento_tri,
				idtipo		CHAR(2),
...
LET query = 'SELECT ',
		...
		'),"NR") SEC, ',
		'"CO" modulo, s23_sustento_tri sustento, ',
		'(SELECT s18_sec_tran ',
		'	FROM srit018  ',
		'	WHERE	      ',
		...
		'base_ice, NVL((SELECT UNIQUE s08_codigo FROM srit008 ',
	...
	' SELECT ',
		...
		'0 base_ice, nvl((SELECT UNIQUE s08_codigo FROM srit008 ',
				' WHERE s08_compania   = p20_compania ',
				'   AND s08_porcentaje = p20_porc_impto), 2)',
		' iva, "0" ice, p20_valor_impto monto_iva, "0.00" monto_ice, ',
		' NVL((SELECT p28_valor_base  ',
			' FROM cxpt028, cxpt027, ordt002 ',
			' WHERE p27_estado      = "A" ',
			'   AND p28_tipo_ret    = "I" ',
...
LET query  = 'SELECT "<detalleAir><codRetAir>" || TRIM(NVL(p28_codigo_sri, "307"))',
			...
			' WHERE p27_compania   = ', codcia,
			'   AND p27_localidad  = ', codloc,
			'   AND p27_estado     = "A" ',
