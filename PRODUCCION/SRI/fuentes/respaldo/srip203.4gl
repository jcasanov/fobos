...
LET query = 'SELECT ',
	...
	--'   and c10_factura    = "001-001-0000613"',
	...
	' SELECT ',
		...
		--'   and p20_num_doc    = "001-001-0000613"',
...
FUNCTION at_air(proveedor, nomprov, tipo, numero, divid)
...
FUNCTION datos_ret(proveedor, nomprov, tipo, numero, divid, tip_ret)
DEFINE proveedor	LIKE cxpt020.p20_codprov
DEFINE nomprov		LIKE cxpt001.p01_nomprov
DEFINE tipo		LIKE cxpt020.p20_tipo_doc
DEFINE numero		LIKE cxpt020.p20_num_doc
