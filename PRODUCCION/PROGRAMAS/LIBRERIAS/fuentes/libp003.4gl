...
CALL fl_genera_detalle_comprob(vm_tipo_comp, subtipo, rm_auxc.b41_ant_mb,'H',
	tot_efe, glosa, rm_caja.j10_codcli, rm_caja.j10_tipo_destino, rm_caja.j10_num_destino)
...
FOREACH q_dic INTO r_dj.*
	...
	CASE r_dj.j11_codigo_pago
		...
		WHEN 'RT'
			...
			CALL fl_genera_detalle_comprob(vm_tipo_comp, subtipo, '11300201002',
        		'D', r_dj.j11_valor, glosa, rm_caja.j10_codcli, rm_caja.j10_tipo_destino, rm_caja.j10_num_destino)
...
FOREACH q_sdbcr1 INTO tipo_comp, subtipo, indice, tipo_doc, num_doc, valor
	LET tipo_mov = 'D'
	LET valor = valor * -1
	IF valor < 0 THEN
		LET tipo_mov = 'H'
