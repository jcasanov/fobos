...
CONSTRUCT BY NAME expr_sql ON z00_compania, z00_credit_auto, z00_bloq_vencido,
	z00_credit_dias, z00_tasa_mora, z00_cobra_mora, z00_aux_clte_mb,
	z00_aux_clte_ma, z00_aux_ant_mb, z00_aux_ant_ma
	ON KEY(F2)
...
IF int_flag THEN
	...
	RETURN
END IF
LET query = 'SELECT *, ROWID FROM cxct000 WHERE ' || expr_sql || ' ORDER BY 1'
...
INPUT BY NAME rm_cxc.z00_compania, rm_cxc.z00_credit_auto,
	rm_cxc.z00_bloq_vencido, rm_cxc.z00_credit_dias, rm_cxc.z00_tasa_mora, 
	rm_cxc.z00_cobra_mora, rm_cxc.z00_aux_clte_mb, rm_cxc.z00_aux_clte_ma,
...
IF vm_num_rows > 0 THEN
	SELECT * INTO rm_cxc.* FROM cxct000 WHERE ROWID=num_registro	
	...
	DISPLAY BY NAME rm_cxc.z00_compania, rm_cxc.z00_credit_auto, 
			...
			rm_cxc.z00_aux_clte_mb, rm_cxc.z00_aux_clte_ma,
			rm_cxc.z00_aux_ant_mb, rm_cxc.z00_aux_ant_ma,
			rm_cxc.z00_mespro, rm_cxc.z00_anopro
	CALL fl_lee_compania(rm_cxc.z00_compania) RETURNING rg_cia.*
	DISPLAY rg_cia.g01_razonsocial TO tit_compania
	CALL fl_lee_cuenta(rm_cxc.z00_compania,rm_cxc.z00_aux_clte_mb)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cli_mb
	CALL fl_lee_cuenta(rm_cxc.z00_compania,rm_cxc.z00_aux_clte_ma)
 		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_cli_ma
	CALL fl_lee_cuenta(rm_cxc.z00_compania,rm_cxc.z00_aux_ant_mb)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_ant_mb
	CALL fl_lee_cuenta(rm_cxc.z00_compania,rm_cxc.z00_aux_ant_ma)
		RETURNING r_cta.*
	DISPLAY r_cta.b10_descripcion TO tit_ant_ma
	CALL muestra_estado()
ELSE
