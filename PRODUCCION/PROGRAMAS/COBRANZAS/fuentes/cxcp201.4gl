...
IF num_args() = 4 THEN
	...
	z21_fecha_emi, z21_moneda, z21_valor, z21_saldo, z21_origen,
	z21_usuario, z21_fecing
        ON KEY(F1,CONTROL-W)
...
IF vm_num_rows > 0 THEN
	...
	DISPLAY BY NAME rm_z21.z21_codcli, rm_z21.z21_tipo_doc, flag_impto,
			...
			rm_z21.z21_paridad, rm_z21.z21_valor,
			rm_z21.z21_val_impto, val_base,
			rm_z21.z21_saldo, rm_z21.z21_origen,
			rm_z21.z21_usuario, rm_z21.z21_fecing, 
			rm_z21.z21_num_sri
	IF vg_gui = 0 THEN
		CALL muestra_origen(rm_z21.z21_origen)
	END IF
