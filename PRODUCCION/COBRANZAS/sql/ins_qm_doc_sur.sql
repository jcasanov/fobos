begin work;
insert into acero_qm@idsuio01:cxct021
	select * from acero_qs@idsuio02:cxct021
		where z21_cod_tran = 'DF'
		  and z21_num_tran = 2613;
	  ...
	  and z20_num_tran in
		(select r19_num_tran
			...
			where r19_compania  = z20_compania
			  ...
			  and r19_cod_tran  = "FA"
			  and r19_tipo_dev  = "DF"
			  and r19_num_dev   = 2613)
	into temp t1;
insert into acero_qm@idsuio01:cxct020 select * from t1;
...
select * from acero_qs@idsuio02:cxct022
	...
	into temp t1;
insert into acero_qm@idsuio01:cxct022 select * from t1;
insert into acero_qm@idsuio01:cxct023 select * from t2;
drop table t2;
commit work;
