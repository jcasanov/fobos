select z20_localidad, z20_codcli, z20_tipo_doc, z20_num_doc, z20_dividendo,
		...
		where z23_compania  = z20_compania
		  ...
		  and z22_fecing    = (select max(z22_fecing)
					...
					where z23_compania   = z20_compania
					  ...
					  and z22_fecing    <=
							"2005-12-31 23:59:59")),
		case when z20_fecha_emi <= mdy(12, 31, 2002)
	...
	where z20_compania   = 1
	  and z20_moneda     = "DO"
	  and z20_fecha_emi <= mdy(12, 31, 2005)
	into temp temp_deu;
...
select z21_localidad localidad, z21_codcli codcli, z21_tipo_doc tipo_doc,
	...
	nvl(case when z21_fecha_emi > mdy(12, 31, 2002) then
		z21_valor +
		...
		case when z21_fecha_emi <= mdy(12, 31, 2002)
	...
	where z21_compania   = 1
	  and z21_moneda     = "DO"
	  and z21_fecha_emi <= mdy(12, 31, 2005)
	into temp temp_fav;
