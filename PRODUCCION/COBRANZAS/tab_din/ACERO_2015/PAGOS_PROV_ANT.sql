SELECT YEAR(p22_fecing) AS anio,
	...
	p01_nomprov AS prov,
	p23_tipo_doc tp, p23_num_doc num, p23_div_doc divi,
	SUM(p23_valor_cap + p23_valor_int) AS sal_cart,
	ABS(DATE(p22_fecing) - p20_fecha_vcto) AS dias,
	SUM((p23_valor_cap + p23_valor_int) *
		ABS(DATE(p22_fecing) - p20_fecha_vcto)) AS edad
