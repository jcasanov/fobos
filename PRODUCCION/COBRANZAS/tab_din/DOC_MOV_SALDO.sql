SELECT "DEUDOR" AS tipo,
	...
	(SELECT LPAD(g02_localidad, 2, 0) || " " || g02_abreviacion
		...
		WHERE g02_compania  = z20_compania
		  AND g02_localidad = z20_localidad) AS localidad,
	...
	FROM cxct020, cxct001, OUTER(cxct023 a, cxct022 b, OUTER(cxct005))
...
SELECT "A FAVOR" AS tipo,
	...
	(SELECT LPAD(g02_localidad, 2, 0) || " " || g02_abreviacion
		...
		WHERE g02_compania  = z21_compania
		  AND g02_localidad = z21_localidad) AS localidad,
	...
	0.00 AS saldo,
	{--
	NVL((a.z23_saldo_cap + a.z23_saldo_int), z21_valor) * (-1) AS valor,
	NVL((a.z23_valor_cap + a.z23_valor_int + a.z23_saldo_cap
		+ a.z23_saldo_int), z21_saldo) * (-1) AS saldo,
	--}
	NVL(b.z22_tipo_trn, "") AS tip_trn,
	NVL(b.z22_num_trn, "") AS num_trn,
	NVL(TO_CHAR(b.z22_fecing, "%Y-%m-%d"), "") AS fec_pag,
	...
	NVL((SELECT z06_nombre
		...
		WHERE z02_compania   = z21_compania
		  ...
		  AND z06_zona_cobro = z02_zona_cobro), "SIN ZONA") AS zon_c,
	--NVL((a.z23_valor_cap + a.z23_valor_int), 0.00) * (-1) AS pago
	0.00 AS pago
	FROM cxct021, cxct001, OUTER(cxct023 a, cxct022 b, OUTER(cxct005))
