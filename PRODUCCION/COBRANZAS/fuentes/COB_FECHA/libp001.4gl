...
CASE r_par.cod_loc
	WHEN '1'
		LET expr_loc = '   AND r02_localidad = 1 '
	WHEN '2'
		LET expr_loc = '   AND r02_localidad = 2 '
	WHEN '3'
		LET expr_loc = '   AND r02_localidad = 3 '
	WHEN '4'
		LET expr_loc = '   AND r02_localidad = 4 '
	WHEN '5'
		LET expr_loc = '   AND r02_localidad = 5 '
	WHEN 'G'
		LET expr_loc = '   AND r02_localidad IN (1, 2) '
	WHEN 'Q'
		LET expr_loc = '   AND r02_localidad IN (3, 4, 5) '
	WHEN 'U'
		LET expr_loc = '   AND r02_localidad IN (3, 5) '
	WHEN 'T'
		LET expr_loc = '   AND r02_localidad IN (1, 2, 3, 4, 5) '
	OTHERWISE
		CALL fl_mostrar_mensaje('La Localidad solo puede ser 1, 2, 3, 4, 5, G, Q, U o T.', 'info')
...
DEFINE i, j		SMALLINT
DEFINE expr_sql		CHAR(300)	## Contiene el CONSTRUCT del usuario
DEFINE query		CHAR(5000)	## Contiene todo el query preparado
DEFINE filas_max	SMALLINT	## No. elementos del arreglo
DEFINE filas_pant	SMALLINT	## No. elementos de cada pantalla
