------------------------------------------------------------------------------
-- Titulo           : cxcp308.4gl - Consulta Acumulados Cartera
-- Elaboracion      : 22-Oct-2001
-- Autor            : YEC
-- Formato Ejecucion: fglrun cxcp308.4gl base_datos modulo compañía
-- Ultima Correccion: 
-- Motivo Correccion:
------------------------------------------------------------------------------
...
OPEN FORM f_cons FROM '../forms/cxcf308_1'
DISPLAY FORM f_cons
...
OPEN WINDOW w_ran AT 6,25 WITH FORM "../forms/cxcf308_2" 
...
DEFINE tipo_cli		LIKE gent012.g12_subtipo
...
FOREACH q_doc INTO r_doc.*
	LET valor  = r_doc.z20_saldo_cap + r_doc.z20_saldo_int
	LET tipo_cli = "*"
	SELECT z01_tipo_clte INTO tipo_cli FROM cxct001
		WHERE z01_codcli = r_doc.z20_codcli
	INSERT INTO tempo_doc VALUES(r_doc.z20_localidad, r_doc.z20_areaneg, 
	        r_doc.z20_moneda,
		r_doc.z20_cartera, tipo_cli, r_doc.z20_tipo_doc,
		r_doc.z20_num_doc, r_doc.z20_dividendo, r_doc.z20_codcli,
		r_doc.z20_fecha_vcto, valor)
...
FOREACH q_cons INTO tipo, fecha, valor, codloc
	...
	CASE rm_par.tipo_detalle 
		WHEN 'A'
			CALL fl_lee_area_negocio(vg_codcia, tipo)
				RETURNING r_an.*
			LET descri = r_an.g03_nombre
		WHEN 'C'
...
WHILE TRUE
	...
	CALL drawinit()
	OPEN WINDOW w_gr1 AT 3,2 WITH FORM "../forms/cxcf308_3"
