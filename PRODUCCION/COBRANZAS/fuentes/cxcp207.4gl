...
IF rm_det[i].j11_protestado = 'S' THEN
	...
	RETURN
END IF
OPEN WINDOW w_for AT 04, 03
        WITH FORM '../forms/cxcf207_2'
...
IF NOT int_flag THEN
	...
	INSERT INTO cxct020 VALUES (rm_caj.j12_compania, rm_caj.j12_localidad,
			...
			rm_cxc.z20_paridad, rm_caj.j12_valor, 0,
			rm_caj.j12_valor, 0, rm_cxc.z20_cartera,
			rm_cxc.z20_linea, NULL, 'A', NULL, NULL,
...
CALL fl_nivel_isolation()
OPEN WINDOW wf2 AT 3,2 WITH 19 ROWS, 80 COLUMNS
    ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE 0, BORDER,
	      MESSAGE LINE LAST - 2)
