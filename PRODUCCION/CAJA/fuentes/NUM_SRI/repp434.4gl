...
PAGE HEADER
	...
	IF rm_r95.r95_motivo = 'V' THEN
		PRINT COLUMN 022, 'X',
		      COLUMN 098, DATE(rm_r19.r19_fecing) USING "dd-mm-yyyy"
	ELSE
		PRINT COLUMN 098, DATE(rm_r19.r19_fecing) USING "dd-mm-yyyy"
	END IF
	IF rm_r95.r95_motivo = 'D' THEN
		...
		ELSE
			PRINT COLUMN 072, ' ';
		END IF
		PRINT COLUMN 098, rm_r95.r95_autoriz_sri
	ELSE
		IF rm_r95.r95_entre_local = 'S' THEN
			PRINT COLUMN 072, 'X';
		ELSE
	...
	END IF
	SKIP 1 LINES
	PRINT COLUMN 080, rm_r95.r95_persona_guia[1, 50] CLIPPED
	PRINT COLUMN 086, rm_r95.r95_persona_id CLIPPED
...
ON EVERY ROW
	IF tot_lineas <= rm_r00.r00_numlin_fact THEN
		NEED 2 LINES
		PRINT COLUMN 004, r_rep.item[1, 7]		CLIPPED,
		      COLUMN 014, r_rep.cantidad	USING '##,##&.##',
...
PAGE HEADER
	...
	IF rm_r95.r95_motivo = 'D' THEN
		...
		ELSE
			PRINT COLUMN 075, ' ';
		END IF
		PRINT COLUMN 099, DATE(rm_r19.r19_fecing) USING "dd-mm-yyyy"
	ELSE
		IF rm_r95.r95_entre_local = 'S' THEN
			PRINT COLUMN 075, 'X';
		ELSE
	...
	ELSE
		PRINT COLUMN 027, ' '
	END IF
	PRINT COLUMN 101, rm_r95.r95_autoriz_sri
	...
	END IF
	SKIP 1 LINES
	PRINT COLUMN 082, rm_r95.r95_persona_guia[1, 50] CLIPPED
	PRINT COLUMN 089, rm_r95.r95_persona_id CLIPPED
