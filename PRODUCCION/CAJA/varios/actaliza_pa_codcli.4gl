------------------------------------------------------------------------------
-- Titulo           : Arreglar Ingresos a Caja por Pagos Anticipos.
-- Elaboracion      : 23-dic-2004
-- Autor            : JCM
-- Formato Ejecucion: fglrun actualiza_PA_codcli base_datos compañía localidad 
--                                               num_pa oldcli newcli
-- Ultima Correccion: 
-- Motivo Correccion: 
------------------------------------------------------------------------------
...
IF r_z01.z01_tipo_doc_id = 'C' OR r_z01.z01_tipo_doc_id = 'R' THEN
	IF fl_validar_cedruc_dig_ver(r_z01.z01_num_doc_id) = 0 THEN
		ROLLBACK WORK
		EXIT PROGRAM
	END IF
END IF
