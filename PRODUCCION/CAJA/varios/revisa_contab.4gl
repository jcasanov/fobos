...
-- CONTADORES
DEFINE facturas_rep	SMALLINT
DEFINE facturas_tal	SMALLINT
DEFINE pagos_cli   	SMALLINT
DEFINE pagos_ant   	SMALLINT
DEFINE otros_ing   	SMALLINT
DEFINE egr_caja    	SMALLINT
...
DECLARE q_tran CURSOR WITH HOLD  FOR 
	SELECT * FROM cajt010 WHERE j10_compania  = 1
				AND j10_localidad = 1
				AND j10_estado = 'P' 
				AND j10_fecha_pro > mdy(08, 28, 2006)
