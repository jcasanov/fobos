...
CASE h
	WHEN 1
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; umask 0002; fglrun cxcp400 ', vg_base, ' ', 'CO', vg_codcia, vg_codloc, ' > cxcp400.txt'
		RUN ejecuta
	WHEN 2
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'CO', 'cxcp401')
...
--DISPLAY fondo		  	TO c000   ## Picture
DISPLAY "boton_consultas"	TO a      ## Picture 
DISPLAY "Activos Fijos" 	TO c100   ## Botón 1  actp300
