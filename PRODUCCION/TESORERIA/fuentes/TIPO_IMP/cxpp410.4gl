...
PAGE HEADER
	...
	PRINT COLUMN 001, 'Fecha impresión: ', TODAY USING 'dd-mmm-yyyy', 
			 1 SPACES, TIME,
              COLUMN 123, usuario
	PRINT COLUMN 001, '------------------------------------------------------------------------------------------------------------------------------------'
	PRINT COLUMN 007, 'P r o v e e d o r',
	      COLUMN 030, 'Fecha Ret.',
	      COLUMN 041, 'No. Ret. SRI',
	      COLUMN 057, 'No. Ret.',
	      COLUMN 066, 'No. Factura',
	      COLUMN 082, 'Fecha Fac.',
	      COLUMN 093, 'Mo',
	      COLUMN 097, 'T',
	      COLUMN 100, '% Ret.',
...
ON EVERY ROW
	NEED 3 LINES
	PRINT COLUMN 001, proveedor[1, 28]	CLIPPED,
	      COLUMN 030, DATE(fecha_retencion)	USING "dd-mm-yyyy",
	      COLUMN 041, num_ret_sri		CLIPPED,
	      COLUMN 057, num_retencion		USING "<<<<<<<<",
	      COLUMN 066, num_factura		CLIPPED,
	      COLUMN 082, fecha_factura		USING "dd-mm-yyyy",
	      COLUMN 093, moneda		CLIPPED, 
	      COLUMN 097, tipo_retencion	CLIPPED,
	      COLUMN 100, porc_retencion	USING '##&.##',
...
PAGE HEADER
	...
	PRINT COLUMN 003, 'P r o v e e d o r e s',
	      COLUMN 054, 'Fecha Ret.',
	      COLUMN 067, 'No. Ret.',
	      COLUMN 076, 'No. Factura',
	      COLUMN 093, 'Fecha Fac.',
	      COLUMN 104, 'Mo',
	      COLUMN 108, '  Valor Base',
	      COLUMN 121, '  Valor Ret.'
	PRINT COLUMN 001, '------------------------------------------------------------------------------------------------------------------------------------'
...
ON EVERY ROW
	...
	PRINT COLUMN 003, codprov		USING "<<<&&&",
	      COLUMN 011, proveedor[1, 27]	CLIPPED,
	      COLUMN 039, DATE(fecha_retencion)	USING "dd-mm-yyyy",
	      COLUMN 050, num_ret_sri		CLIPPED,
	      COLUMN 066, num_retencion		USING "<<<<<<<<",
	      COLUMN 076, num_factura		CLIPPED,
	      COLUMN 093, fecha_factura		USING "dd-mm-yyyy",
	      COLUMN 104, moneda		CLIPPED, 
	      COLUMN 108, valor_base		USING '#,###,##&.##',
	      COLUMN 121, valor_retencion	USING '#,###,##&.##'
...
PAGE HEADER
	...
	PRINT COLUMN 001, 'Fecha impresión: ', TODAY USING 'dd-mmm-yyyy', 
			 1 SPACES, TIME,
              COLUMN 123, usuario
	PRINT COLUMN 001, '------------------------------------------------------------------------------------------------------------------------------------'
	PRINT COLUMN 023, 'Fecha Ret.',
	      COLUMN 034, 'No. Ret. SRI',
	      COLUMN 050, 'No. Ret.',
	      COLUMN 059, 'No. Factura',
	      COLUMN 075, 'Fecha Fac.',
	      COLUMN 086, 'Mo',
	      COLUMN 090, 'T',
	      COLUMN 093, '% Ret.',
	      COLUMN 100, 'C. SRI',
...
ON EVERY ROW
	NEED 6 LINES
	PRINT COLUMN 023, DATE(fecha_retencion)	USING "dd-mm-yyyy",
	      COLUMN 034, num_ret_sri		CLIPPED,
	      COLUMN 050, num_retencion		USING "<<<<<<<<",
	      COLUMN 059, num_factura		CLIPPED,
	      COLUMN 075, fecha_factura		USING "dd-mm-yyyy",
	      COLUMN 086, moneda		CLIPPED, 
	      COLUMN 090, tipo_retencion	CLIPPED,
	      COLUMN 093, porc_retencion	USING '##&.##',
	      COLUMN 100, codigo_sri		USING "<<<<<<",
	      COLUMN 108, valor_base		USING '#,###,##&.##',
	      COLUMN 121, valor_retencion	USING '#,###,##&.##'
	LET vm_tot_bas = vm_tot_bas + valor_base
	LET vm_tot_ret = vm_tot_ret + valor_retencion
