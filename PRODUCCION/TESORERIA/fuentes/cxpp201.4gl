...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/cxpp201.err')
--#CALL fgl_init4js()
...
ELSE
	OPEN FORM f_cxp FROM "../forms/cxpf201_1c"
END IF
DISPLAY FORM f_cxp
	...
	BEGIN WORK
		...
		IF resul THEN
			...
			VALUES (rm_p21.p21_compania, rm_p21.p21_localidad,
				...
				rm_p21.p21_num_doc, r_b12.b12_tipo_comp,
				r_b12.b12_num_comp)
		END IF
	COMMIT WORK
	IF resul THEN
...
END IF
LET int_flag = 0
INPUT BY NAME rm_p21.p21_codprov, rm_p21.p21_tipo_doc, rm_p21.p21_num_doc,
	rm_p21.p21_subtipo, rm_p21.p21_referencia, rm_p21.p21_fecha_emi,
	rm_p21.p21_moneda, rm_p21.p21_valor
	WITHOUT DEFAULTS
	ON KEY(INTERRUPT)
	        IF field_touched(rm_p21.p21_codprov, rm_p21.p21_tipo_doc,
			rm_p21.p21_num_doc, rm_p21.p21_subtipo,
	...
	AFTER FIELD p21_subtipo
		IF rm_p21.p21_subtipo IS NOT NULL THEN
			CALL fl_lee_subtipo_entidad(rm_p21.p21_tipo_doc,
							rm_p21.p21_subtipo)
				RETURNING r_sub.*
...
IF num_args() = 8 THEN
	...
	END IF
END IF
DISPLAY BY NAME rm_p21.p21_codprov, rm_p21.p21_tipo_doc,
		rm_p21.p21_num_doc, rm_p21.p21_subtipo,
		rm_p21.p21_referencia, rm_p21.p21_fecha_emi,
		rm_p21.p21_moneda, rm_p21.p21_paridad, rm_p21.p21_valor,
		rm_p21.p21_saldo, rm_p21.p21_origen, rm_p21.p21_usuario,
		rm_p21.p21_fecing
