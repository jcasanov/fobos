...
SELECT n30_cod_trab AS CODIGO,
	TRIM(n30_nombres) AS EMPLEADOS,
	0.00 AS TOTAL_GAN_NOM,
	0.00 AS APORTES_IESS,
	0.00 AS TOTAL_NOMINA,
	0.00 AS BONIFICACION,
	3000.00 AS OTRAS_BONIFIC,
	0.00 AS OTROS_VAL_NOM,
	NVL((SELECT SUM((n39_valor_vaca + n39_valor_adic) - n39_descto_iess)
		FROM rolt039
		WHERE n39_compania      = n30_compania
		  AND n39_proceso      IN ("VA", "VP")
		  AND n39_cod_trab      = n30_cod_trab
		  AND EXTEND(n39_fecing, YEAR TO MONTH) =
				EXTEND(MDY(03, 01, 2013),
		YEAR TO MONTH)), 0.00) AS NETO_VACACIONES,
	0.00 AS UTILIDADES
	FROM rolt030
