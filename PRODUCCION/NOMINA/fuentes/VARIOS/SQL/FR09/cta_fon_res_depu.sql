...
select cia compa, cod_depto dep, trim('51010802' || lpad(secuencia, 3, 0)) cta,
	...
	select cia compa, cod_depto dep,
		trim('51010803' || lpad(secuencia, 3, 0)) cta,
...
begin work;
	...
	insert into ctbt010
		...
		values (1, '51010802', 'FONDO DE RESERVA MENSUAL TRABAJADORES',
	...
	insert into ctbt010
		(b10_compania, b10_cuenta, b10_descripcion, b10_descri_alt,
		 b10_estado, b10_tipo_cta, b10_tipo_mov, b10_nivel,
		 b10_cod_ccosto, b10_saldo_ma, b10_usuario, b10_fecing)
		values (1, '51010803','FONDO DE RESERVA ACUMULADO TRABAJADORES',
