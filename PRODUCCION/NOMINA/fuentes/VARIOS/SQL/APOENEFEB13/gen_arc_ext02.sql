...
load from "extras_feb13_ori.txt" delimiter ";" insert into temp_aj;
...
unload to "emp_val_ext_feb13.unl" select * from t2 order by 2;

unload to "extras_feb13_aju.txt" delimiter ";"
