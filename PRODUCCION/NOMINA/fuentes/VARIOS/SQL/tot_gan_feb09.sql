SELECT UNIQUE n32_cod_trab AS codigo,
	...
	NVL((SELECT SUM(b13_valor_base)
		...
		WHERE n56_compania    = n30_compania
		  ...
		  AND b12_estado     <> 'E'
		  AND extend(b12_fec_proceso, year to month) = '2009-02'
	...
	WHERE a.n32_compania    = 1
	  ...
	  AND a.n32_fecha_ini  >= MDY (02, 01, 2009)
	  AND a.n32_fecha_fin  <= MDY (02, 28, 2009)
