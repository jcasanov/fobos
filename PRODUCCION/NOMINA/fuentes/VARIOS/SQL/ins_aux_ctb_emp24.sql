select b10_cuenta cuenta, trim(replace(b10_descripcion,
	...
	where b10_compania    = 1
	  and b10_descripcion matches '*CORDOVA*RU*'
	  and b10_estado      = 'A'
	into temp t1;
...
select unique n56_compania cia, n56_proceso pro, n56_cod_depto dep,
	...
	into temp t2;
select a.b10_compania cia, cuenta[1, 8] || '096' cta,
...
begin work;
	...
	insert into rolt052
		...
		select n52_compania, n52_cod_rubro, 193,
			n52_aux_cont[1, 8] || '096'
			from rolt052
