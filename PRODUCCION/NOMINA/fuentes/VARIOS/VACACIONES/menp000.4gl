...
DISPLAY "Inventario Físico"     TO c2300  ## Botón 21 repp239
DISPLAY "Pedido Prov. Locales"  TO c2400  ## Botón 22 repp240
DISPLAY "Traspaso a La Prensa"  TO c2500  ## Botón 23 repp667
...
'RE', vg_codcia, vg_codloc
	...
	WHEN 8
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'REPUESTOS', vg_separador, 'fuentes', vg_separador, '; fglrun repp222 ', vg_base, ' ',
'RE', vg_codcia
		RUN ejecuta
	{--
	WHEN 9
...
DISPLAY "Inventario Físico"      TO c1500  ## Botón 15 repp317
...
CASE h
	...
	WHEN 10
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'COBRANZAS', vg_separador, 'fuentes', vg_separador, '; umask 0002; fglrun cxcp417 ', vg_base, ' ', 'CO', vg_codcia, vg_codloc, ' > cxcp417.txt'
	 	RUN ejecuta
	WHEN 0
		CLOSE WINDOW w_menu_reportes
		CALL menu_cobranzas()
...
CASE h
	...
	WHEN 2
		...
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'CONTABILIDAD', vg_separador, 'fuentes', vg_separador, '; umask 0002; fglrun ctbp402 ', vg_base, ' ', 'CB', vg_codcia, ' > ctbp402.txt'
		RUN ejecuta
	WHEN 3
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'CB', 'ctbp403')
		THEN
			EXIT CASE
		END IF
		LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'CONTABILIDAD', vg_separador, 'fuentes', vg_separador, '; umask 0002; fglrun ctbp403 ', vg_base, ' ', 'CB', vg_codcia, ' > ctbp403.txt'
		RUN ejecuta
	WHEN 4
		IF NOT fl_control_acceso_proceso_men(vg_usuario, vg_codcia,
							'CB', 'ctbp404')
	...
	CASE c
		WHEN 1
			...
			THEN
				EXIT CASE
			END IF
			LET ejecuta = 'cd ..', vg_separador, '..', vg_separador, 'SRI', vg_separador, 'fuentes', vg_separador, '; fglrun srip201 ', vg_base, ' ', 'SR', vg_codcia, ' ', vg_codloc
			RUN ejecuta
		WHEN 2
			IF NOT fl_control_acceso_proceso_men(vg_usuario,
