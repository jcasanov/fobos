SELECT n30_cod_trab AS codi,
	...
	CASE WHEN TRUNC((((TODAY - n30_fecha_nacim) + 1) /
        ...
        END AS tie_eda,
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 5)) =
			a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
		...
		WHERE b.n32_compania         = n30_compania
		  ...
		  AND DATE(b.n32_fecha_ini) BETWEEN
			DATE(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 5))
			AND DATE(MDY(12, 31, YEAR(TODAY) - 5))) / 2, 2)
			ELSE 0.00
		END), 0.00), 2) AS prom_anio1,
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 4)) =
			a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
        ...
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 3)) =
			a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
        ...
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 2)) =
			a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
        ...
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 1)) =
			a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
        ...
        ROUND(NVL(SUM(
		CASE WHEN YEAR(MDY(MONTH(TODAY), 01, YEAR(TODAY)) - 1 UNITS DAY)
			= a.n32_ano_proceso
			THEN a.n32_tot_gan
			ELSE 0.00
		...
		WHERE b.n32_compania         = n30_compania
		  ...
		  AND b.n32_cod_trab         = n30_cod_trab
		  AND DATE(b.n32_fecha_ini) BETWEEN
			DATE(MDY(01, 01, YEAR(TODAY)))
			AND DATE(MDY(MONTH(TODAY), 01, YEAR(TODAY))
				- 1 UNITS DAY)) / 2, 2)
			ELSE 0.00
	...
	WHERE n30_compania                            = 1
	  ...
	  AND EXTEND(a.n32_fecha_fin, YEAR TO MONTH) BETWEEN
		EXTEND(MDY(MONTH(TODAY), 01, YEAR(TODAY) - 5), YEAR TO MONTH)
		AND EXTEND(MDY(MONTH(TODAY), 01, YEAR(TODAY)) - 1 UNITS DAY,
			YEAR TO MONTH)
