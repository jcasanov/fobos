...
SELECT CASE WHEN n30_sub_activ = "1" THEN "01 ACERO GUAYAQUIL"
		...
		ELSE "OTROS"
	END AS local,
	a.n39_ano_proceso AS anio,
	CASE WHEN a.n39_mes_proceso = 01 THEN "ENERO"
	     WHEN a.n39_mes_proceso = 02 THEN "FEBRERO"
	     WHEN a.n39_mes_proceso = 03 THEN "MARZO"
	     WHEN a.n39_mes_proceso = 04 THEN "ABRIL"
	     WHEN a.n39_mes_proceso = 05 THEN "MAYO"
	     WHEN a.n39_mes_proceso = 06 THEN "JUNIO"
	     WHEN a.n39_mes_proceso = 07 THEN "JULIO"
	     WHEN a.n39_mes_proceso = 08 THEN "AGOSTO"
	     WHEN a.n39_mes_proceso = 09 THEN "SEPTIEMBRE"
	     WHEN a.n39_mes_proceso = 10 THEN "OCTUBRE"
	     WHEN a.n39_mes_proceso = 11 THEN "NOVIEMBRE"
	     WHEN a.n39_mes_proceso = 12 THEN "DICIEMBRE"
	END AS mes,
	"OT" AS cod_lq,
	"OTROS INGRESOS" AS nom_lq,
