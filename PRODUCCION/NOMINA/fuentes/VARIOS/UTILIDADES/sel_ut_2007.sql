SELECT 1 loc_c, n31_cod_trab, n31_tipo_carga, COUNT(n31_secuencia) tot_carg
	...
	WHERE n31_compania     = 1
	  ...
	  AND n31_fecha_nacim <= MDY(12, 31, 2007)
...
SELECT 1 localidad, n30_cod_trab cod_trab, n30_nombres nombres,
	...
	NVL((SELECT n42_dias_trab
		...
		WHERE n42_compania = n30_compania
		  ...
		  AND n42_ano      = 2007),
	CASE WHEN YEAR(n30_fecha_ing) = 2007
		THEN ((MDY(12, 31, 2007) -
	...
	WHERE n30_compania    = 1
	  AND n30_fecha_ing  <= MDY(12, 31, 2007)
	...
	SELECT 1 localidad, n30_cod_trab cod_trab, n30_nombres nombres,
		...
		NVL((SELECT n42_dias_trab
			...
			WHERE n42_compania = n30_compania
			  AND n42_cod_trab = n30_cod_trab
			  AND n42_ano      = 2007),
		CASE WHEN YEAR(n30_fecha_ing) <> 2007 AND
			n30_fecha_reing IS NULL
			THEN (n30_fecha_sal - MDY(01, 01, 2007) + 1)
		     WHEN YEAR(n30_fecha_ing) = 2007 AND
			n30_fecha_reing IS NOT NULL
			THEN (MDY(12, 31, 2007) - n30_fecha_reing) + 1
		     WHEN n30_fecha_ing > MDY(01, 01, 2007) AND
				YEAR(n30_fecha_sal) > 2007
			THEN (MDY(12, 31, 2007) - n30_fecha_ing) + 1
		     WHEN n30_fecha_ing > MDY(01, 01, 2007) AND
			  n30_fecha_sal > MDY(01, 01, 2007) AND
			  n30_fecha_sal < MDY(12, 31, 2007)
			THEN (n30_fecha_sal - n30_fecha_ing) + 1
		     WHEN n30_fecha_reing > MDY(01, 01, 2007) AND
...
DELETE FROM te_trab
	WHERE fecha_reing      > MDY(12, 31, 2007)
	  AND YEAR(fecha_sal) <> 2007;

DELETE FROM te_trab
	WHERE  fecha_sal   < MDY(01, 01, 2007)
	  AND (fecha_reing IS NULL
	   OR  fecha_reing > MDY(12, 31, 2007));
