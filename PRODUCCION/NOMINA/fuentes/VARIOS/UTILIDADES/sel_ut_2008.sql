...
DELETE FROM te_trab
	WHERE fecha_reing      > MDY(12, 31, 2008)
	  AND YEAR(fecha_sal) <> 2008;

DELETE FROM te_trab
	WHERE  fecha_sal   < MDY(01, 01, 2008)
