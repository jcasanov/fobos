...
FOREACH q_te_trab INTO r_trab.*
	...
	IF vg_codloc = 1 AND r_trab.cod_trab = 193 THEN
		LET r_trab.dias_trab = 25
	END IF
	IF vg_codloc = 3 AND r_trab.cod_trab = 424 THEN
		LET r_trab.dias_trab = 282
	END IF
	UPDATE te_trab
...
LET expr_trab2 = NULL
IF vg_codloc = 3 THEN
	LET expr_trab2 = '   AND n30_cod_trab <> 477 '
END IF
...
LET query = 'SELECT n30_cod_trab, n30_nombres, n30_estado, n30_fecha_ing, ',
	...
	'SELECT n30_cod_trab, n30_nombres, n30_estado, n30_fecha_ing, ',
		...
		'  AND YEAR(NVL(n30_fecha_reing, n30_fecha_ing)) <= ',
			rm_par.n41_ano,
		'  AND n30_tipo_contr       = "F" ',
		'  AND n30_tipo_trab        = "N" ',
	 	'  AND n30_fec_jub         IS NULL ',
...
LET query = 'SELECT "PA" AS tip_pag, g09_numero_cta AS cuenta_empr,',
		...
		'   AND g09_numero_cta  = n42_cta_empresa ',
