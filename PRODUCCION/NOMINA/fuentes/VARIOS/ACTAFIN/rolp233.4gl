--------------------------------------------------------------------------------
-- Titulo           : rolp233.4gl - Acta Finiquito de Empleados
-- Elaboracion      : 12-Abr-2013
-- Autor            : NPC
-- Formato Ejecucion: fglrun rolp233 base modulo compañía [cod_trab]
-- Ultima Correccion: 
-- Motivo Correccion: 
--------------------------------------------------------------------------------
...
DEFINE rm_par2		RECORD
				...
				n74_sectorial	LIKE rolt074.n74_sectorial,
				n74_fecha_sal	LIKE rolt074.n74_fecha_sal,
				n74_fecha_ent	LIKE rolt074.n74_fecha_ent,
				n74_sueldo_prom	LIKE rolt074.n74_sueldo_prom,
				n74_tipo_acta	LIKE rolt074.n74_tipo_acta,
				n73_conc_abr	LIKE rolt073.n73_conc_abr,
				n74_desah_parc	LIKE rolt074.n74_desah_parc,
				n74_motivo	LIKE rolt074.n74_motivo,
...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/rolp233.err')
--#CALL fgl_init4js()
...
IF r_n03.n03_proceso IS NULL THEN
	CALL fl_mostrar_mensaje('No existe configurado el proceso ACTA DE FINIQUITO en la tabla rolt003.', 'stop')
	EXIT PROGRAM
END IF
LET lin_menu = 0
LET row_ini  = 3
...
IF vg_gui = 0 THEN
	...
	LET num_cols = 78
END IF
OPEN WINDOW w_rolf233_1 AT row_ini, 2 WITH num_rows ROWS, num_cols COLUMNS
	ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE lin_menu,
		  MESSAGE LINE LAST, BORDER) 
IF vg_gui = 1 THEN
	OPEN FORM f_rolf233_1 FROM '../forms/rolf233_1'
ELSE
	OPEN FORM f_rolf233_1 FROM '../forms/rolf233_1c'
END IF
DISPLAY FORM f_rolf233_1
...
MENU 'OPCIONES'
	...
	COMMAND KEY('I') 'Ingresar' 'Ingresar nuevos registros. '
		...
		CALL control_modificacion()
       	COMMAND KEY('F') 'Forma de Pago' 'Forma de Pago del Acta. '
		CALL control_forma_pago()
       	COMMAND KEY('Z') 'Contabilización' 'Contabilización del Acta. '
...
IF vg_gui = 0 THEN
	...
	LET num_cols = 78
END IF
OPEN WINDOW w_rolf233_3 AT row_ini, 06 WITH num_rows ROWS, num_cols COLUMNS
	ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE lin_menu,
		  MESSAGE LINE LAST, BORDER) 
IF vg_gui = 1 THEN
	OPEN FORM f_rolf233_3 FROM '../forms/rolf233_3'
ELSE
	OPEN FORM f_rolf233_3 FROM '../forms/rolf233_3c'
END IF
DISPLAY FORM f_rolf233_3
...
IF vg_gui = 0 THEN
	...
	LET num_cols = 58
END IF
OPEN WINDOW w_rolf233_2 AT 09, 13 WITH num_rows ROWS, num_cols COLUMNS
	ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE lin_men, BORDER,
		  MESSAGE LINE LAST)
IF vg_gui = 1 THEN
	OPEN FORM f_rolf233_2 FROM '../forms/rolf233_2'
ELSE
	OPEN FORM f_rolf233_2 FROM '../forms/rolf233_2c'
END IF
DISPLAY FORM f_rolf233_2
...
IF vg_gui = 0 THEN
	...
	LET num_cols = 78
END IF
OPEN WINDOW w_rolf233_4 AT 05, 02 WITH num_rows ROWS, num_cols COLUMNS
	ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE lin_men, BORDER,
		  MESSAGE LINE LAST)
IF vg_gui = 1 THEN
	OPEN FORM f_rolf233_4 FROM '../forms/rolf233_4'
ELSE
	OPEN FORM f_rolf233_4 FROM '../forms/rolf233_4c'
END IF
DISPLAY FORM f_rolf233_4
...
CASE estado
	...
	WHEN 'P'
		DISPLAY 'PROCESADO'     TO desc_est
	WHEN 'E'
		DISPLAY 'ELIMINADO'     TO desc_est
	OTHERWISE
		CLEAR n74_estado, desc_est
END CASE
...
IF vg_gui = 0 THEN
	...
	LET num_cols = 72
END IF
OPEN WINDOW w_rolf233_5 AT 10, 05 WITH num_rows ROWS, num_cols COLUMNS
	ATTRIBUTE(FORM LINE FIRST, COMMENT LINE LAST, MENU LINE lin_men, BORDER,
		  MESSAGE LINE LAST)
IF vg_gui = 1 THEN
	OPEN FORM f_rolf233_5 FROM '../forms/rolf233_5'
ELSE
...
OPEN WINDOW w_rolf233_6 AT 09, 12 WITH FORM "../forms/rolf233_6" 
