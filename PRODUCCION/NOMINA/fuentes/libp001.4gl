	...
	IF NOT primera THEN
		...
		IF int_flag THEN
			...
			RETURN rh_ctabco[1].g08_banco, rh_ctabco[1].g08_nombre,
				rh_ctabco[1].g09_tipo_cta,
				rh_ctabco[1].g09_numero_cta 
		END IF
	ELSE
		LET expr_sql = ' 1 = 1'
	END IF
...
CASE r_par.tipo_ident
	WHEN 'C'
		LET expr_t_i = '   AND r02_tipo_ident = "C" '
	WHEN 'R'
		LET expr_t_i = '   AND r02_tipo_ident = "R" '
	WHEN 'I'
		LET expr_t_i = '   AND r02_tipo_ident = "I" '
	WHEN 'V'
		LET expr_t_i = '   AND r02_tipo_ident = "V" '
	WHEN '0'
		LET expr_t_i = '   AND r02_tipo_ident IN ("V", "I") '
	WHEN '1'
		LET expr_t_i = '   AND r02_tipo_ident IN ("V", "I", "R") '
	WHEN '2'
		LET expr_t_i = '   AND r02_tipo_ident IN ("V", "I", "R", "C") '
	WHEN '3'
...
IF proc = 'FR' THEN
	...
	IF valor_fec > 0 AND valor_fec < 365 THEN
		...
		IF DAY(fec_ini) >= 15 THEN
			LET dia = 16
		END IF
		IF fec_fin > MDY(06, 30, 2009) THEN
		...
		IF DAY(fec_ini) <> 1 AND primera THEN
			...
			ELSE
				CALL fl_lee_trabajador_roles(cod_cia, cod_trab)
					RETURNING r_n30.*
				LET fec_ini = MDY(MONTH(r_n30.n30_fecha_ing),
