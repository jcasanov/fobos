...
SELECT b12_compania cia, b12_tipo_comp tp, b12_num_comp num
	...
	INTO TEMP tmp_ctb
LOAD FROM "gen_ant.unl" INSERT INTO tmp_emp
DISPLAY ' '
...
{--
IF cod_trab <> 21 AND cod_trab <> 49 AND cod_trab <> 99 THEN
	LET rm_n45.n45_cod_rubro     = 68
ELSE
	LET rm_n45.n45_cod_rubro     = 70
END IF
--}
LET rm_n45.n45_cod_rubro     = 72
LET rm_n45.n45_cod_trab      = cod_trab
LET rm_n45.n45_estado        = 'A'
--LET rm_n45.n45_referencia    = 'ANT. PARA AYUDAR A FRANCO'
LET rm_n45.n45_referencia    = 'ANT. POR SEMANA SANTA'
SQL
	--SELECT EXTEND(MDY(03, 31, 2009), YEAR TO SECOND) + 17 UNITS HOUR
	SELECT EXTEND(MDY(04, 09, 2009), YEAR TO SECOND) + 17 UNITS HOUR
...
LET r_n46.n46_fecha_ini  = MDY(04, 01, 2009)
LET r_n46.n46_fecha_fin  = MDY(04, 15, 2009)
