...
DEFINE expr_ced		CHAR(120)
DEFINE expr_sue		CHAR(120)
DEFINE v_rus		SMALLINT

LET query    = NULL
LET expr_tab = ' INTO TEMP t1'
LET expr_ced = ' n30_num_doc_id cedula, '
IF flag = 2 THEN
	LET expr_ced = ' CASE WHEN n30_num_doc_id <> "0913236147" ',
			'THEN n30_num_doc_id ELSE "6100006268" END CASE, '
