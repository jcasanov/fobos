select n30_num_doc_id, n30_cod_trab, n30_nombres, n33_valor tot_gan,
	n33_valor rus, n33_valor aporte, n33_valor dec_ter, n33_valor dec_cua
...
select n30_num_doc_id, n30_cod_trab, n30_nombres, sum(n33_valor) tot_gan,
	0 rus, 0 aporte, 0 dec_ter, 0 dec_cua
	from rolt030, rolt033
...
unload to "impto_renta.txt"
	select n30_num_doc_id, n30_nombres, tot_gan, rus, aporte, dec_ter,
			dec_cua
		from t1
		order by 2;
drop table t1;
