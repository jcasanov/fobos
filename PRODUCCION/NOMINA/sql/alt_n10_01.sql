...
alter table "fobos".rolt010 add (n10_cod_liqrol char(2) before n10_cod_rubro);
...
alter table "fobos".rolt010 modify (n10_cod_liqrol char(2) not null);

create unique index "fobos".i01_pk_rolt010 on "fobos".rolt010
	(n10_compania, n10_cod_liqrol, n10_cod_rubro, n10_cod_trab) in idxdbs;
...
alter table "fobos".rolt010
	add constraint
		primary key (n10_compania, n10_cod_liqrol, n10_cod_rubro,
				n10_cod_trab)
