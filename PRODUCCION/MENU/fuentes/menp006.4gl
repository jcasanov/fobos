------------------------------------------------------------------------------
-- Titulo           : menp006.4gl - MENU PRINCIPAL DE FHOBOS CONTROL SRI
-- Elaboracion      : 27-Jul-2004
-- Autor            : NPC
-- Formato Ejecucion: fglrun menp006 base modulo
-- Ultima Correccion: 
-- Motivo Correccion: 
------------------------------------------------------------------------------
...
DEFER INTERRUPT
CLEAR SCREEN
CALL startlog('../logs/menp006.err')
--#CALL fgl_init4js()
...
LET vg_proceso   = 'menp006'
LET vm_titprog   = 'MENU PHOBOS - CONTROL SRI'
...
WHILE TRUE
OPEN WINDOW w_menu_control_sri AT 3,2 WITH 22 ROWS, 80 COLUMNS
	ATTRIBUTE(FORM LINE FIRST , COMMENT LINE LAST, MENU LINE FIRST,
		  BORDER, MESSAGE LINE LAST - 2) 
OPEN FORM f_menf203 FROM '../forms/menf203'
DISPLAY FORM f_menf203
DISPLAY "boton_generales"    TO a      ## Picture 
DISPLAY "Control Doc. SRI"   TO c100   ## Botón
DISPLAY "Control Sec. SRI"   TO c200   ## Botón
